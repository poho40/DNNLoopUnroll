...
321:                                              ; preds = %395, %383, %371, %359, %347, %335, %323, %317
...
347:                                              ; preds = %335
  ...
  %350 = getelementptr inbounds [100 x i32], ptr %3, i64 0, i64 %349
  %351 = load i32, ptr %350, align 4
  %352 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %351)
  %353 = call i32 (ptr, ...) @printf(ptr noundef @.str.2)
...
383:                                              ; preds = %371
  ...
  %386 = getelementptr inbounds [100 x i32], ptr %3, i64 0, i64 %385
  %387 = load i32, ptr %386, align 4
  %388 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %387)
  %389 = call i32 (ptr, ...) @printf(ptr noundef @.str.2)
  ...
  br i1 %394, label %321, label %395

395:                                              ; preds = %383
  %396 = load i32, ptr %4, align 4
  %397 = sext i32 %396 to i64
  %398 = getelementptr inbounds [100 x i32], ptr %3, i64 0, i64 %397
