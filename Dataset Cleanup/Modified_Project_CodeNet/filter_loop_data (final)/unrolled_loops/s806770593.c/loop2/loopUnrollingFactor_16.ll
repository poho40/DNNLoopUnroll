...
966:                                              ; preds = %962
  ...
  %968 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %967)
  br label %972
...
976:                                              ; preds = %956, %939, %922, %905, %888, %871, %854, %837, %820, %803, %786, %769, %752, %735, %718, %703
  %977 = load i32, ptr %1, align 4
  ret i32 %977
}
