...
1166:                                             ; preds = %1160
  ...
  br i1 %1172, label %1173, label %1364

1173:                                             ; preds = %1166
  %1174 = load i32, ptr %3, align 4
  %1175 = sext i32 %1174 to i64
  %1176 = getelementptr inbounds [101 x i32], ptr %4, i64 0, i64 %1175
...
1192:                                             ; preds = %1186
  ...
  br i1 %1198, label %1199, label %1364

1199:                                             ; preds = %1192
  %1200 = load i32, ptr %3, align 4
  %1201 = sext i32 %1200 to i64
  %1202 = getelementptr inbounds [101 x i32], ptr %4, i64 0, i64 %1201
...
1205:                                             ; preds = %1199
  ...
  store i32 %1207, ptr %3, align 4
  %1208 = load i32, ptr %3, align 4
  %1209 = load i32, ptr %2, align 4
  %1210 = sub nsw i32 %1209, 1
  %1211 = icmp sle i32 %1208, %1210
  br i1 %1211, label %1212, label %1364

1212:                                             ; preds = %1205
  %1213 = load i32, ptr %3, align 4
  %1214 = sext i32 %1213 to i64
  %1215 = getelementptr inbounds [101 x i32], ptr %4, i64 0, i64 %1214
...
1218:                                             ; preds = %1212
  ...
  %1224 = icmp sle i32 %1221, %1223
  br i1 %1224, label %1225, label %1364

1225:                                             ; preds = %1218
  %1226 = load i32, ptr %3, align 4
  %1227 = sext i32 %1226 to i64
  %1228 = getelementptr inbounds [101 x i32], ptr %4, i64 0, i64 %1227
...
1231:                                             ; preds = %1225
  ...
  %1237 = icmp sle i32 %1234, %1236
  br i1 %1237, label %1238, label %1364

1238:                                             ; preds = %1231
  %1239 = load i32, ptr %3, align 4
  %1240 = sext i32 %1239 to i64
  %1241 = getelementptr inbounds [101 x i32], ptr %4, i64 0, i64 %1240
...
1244:                                             ; preds = %1238
  ...
  store i32 %1246, ptr %3, align 4
  %1247 = load i32, ptr %3, align 4
  %1248 = load i32, ptr %2, align 4
  %1249 = sub nsw i32 %1248, 1
  %1250 = icmp sle i32 %1247, %1249
  br i1 %1250, label %1251, label %1364

1251:                                             ; preds = %1244
  %1252 = load i32, ptr %3, align 4
  %1253 = sext i32 %1252 to i64
  %1254 = getelementptr inbounds [101 x i32], ptr %4, i64 0, i64 %1253
...
1264:                                             ; preds = %1257
  ...
  %1267 = getelementptr inbounds [101 x i32], ptr %4, i64 0, i64 %1266
...
1270:                                             ; preds = %1264
  ...
  store i32 %1272, ptr %3, align 4
  %1273 = load i32, ptr %3, align 4
  %1274 = load i32, ptr %2, align 4
  %1275 = sub nsw i32 %1274, 1
  %1276 = icmp sle i32 %1273, %1275
  br i1 %1276, label %1277, label %1364

1277:                                             ; preds = %1270
  %1278 = load i32, ptr %3, align 4
  %1279 = sext i32 %1278 to i64
  %1280 = getelementptr inbounds [101 x i32], ptr %4, i64 0, i64 %1279
  %1281 = load i32, ptr %1280, align 4
  %1282 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %1281)
  br label %1283
...
1283:                                             ; preds = %1277
  ...
  br i1 %1289, label %1290, label %1364

1290:                                             ; preds = %1283
  %1291 = load i32, ptr %3, align 4
  %1292 = sext i32 %1291 to i64
  %1293 = getelementptr inbounds [101 x i32], ptr %4, i64 0, i64 %1292
  %1294 = load i32, ptr %1293, align 4
  %1295 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %1294)
  br label %1296
...
1303:                                             ; preds = %1296
  ...
  %1306 = getelementptr inbounds [101 x i32], ptr %4, i64 0, i64 %1305
...
1309:                                             ; preds = %1303
  ...
  br i1 %1315, label %1316, label %1364

1316:                                             ; preds = %1309
  %1317 = load i32, ptr %3, align 4
  %1318 = sext i32 %1317 to i64
  %1319 = getelementptr inbounds [101 x i32], ptr %4, i64 0, i64 %1318
...
1329:                                             ; preds = %1322
  ...
  %1332 = getelementptr inbounds [101 x i32], ptr %4, i64 0, i64 %1331
  %1333 = load i32, ptr %1332, align 4
  %1334 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %1333)
  br label %1335
...
1335:                                             ; preds = %1329
  ...
  %1341 = icmp sle i32 %1338, %1340
  br i1 %1341, label %1342, label %1364

1342:                                             ; preds = %1335
  %1343 = load i32, ptr %3, align 4
  %1344 = sext i32 %1343 to i64
  %1345 = getelementptr inbounds [101 x i32], ptr %4, i64 0, i64 %1344
  %1346 = load i32, ptr %1345, align 4
  %1347 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %1346)
  br label %1348
...
1348:                                             ; preds = %1342
  ...
  %1354 = icmp sle i32 %1351, %1353
  br i1 %1354, label %1355, label %1364

1355:                                             ; preds = %1348
  %1356 = load i32, ptr %3, align 4
  %1357 = sext i32 %1356 to i64
  %1358 = getelementptr inbounds [101 x i32], ptr %4, i64 0, i64 %1357
...
1364:                                             ; preds = %1348, %1335, %1322, %1309, %1296, %1283, %1270, %1257, %1244, %1231, %1218, %1205, %1192, %1179, %1166, %1155
  %1365 = load i32, ptr %2, align 4
  %1366 = sext i32 %1365 to i64
  %1367 = getelementptr inbounds [101 x i32], ptr %4, i64 0, i64 %1366
  %1368 = load i32, ptr %1367, align 4
  %1369 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %1368)
  ret i32 0
}
