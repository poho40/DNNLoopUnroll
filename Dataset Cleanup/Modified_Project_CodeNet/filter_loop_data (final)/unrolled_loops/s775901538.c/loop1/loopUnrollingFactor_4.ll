...
256:                                              ; preds = %342, %255
  ...
  %259 = call i64 @strlen(ptr noundef %2) #5
...
320:                                              ; preds = %319
  ...
  %325 = call i64 @strlen(ptr noundef %2) #5
...
327:                                              ; preds = %320
  ...
  %330 = getelementptr inbounds [10 x i8], ptr %2, i64 0, i64 %329
  %331 = load i8, ptr %330, align 1
  %332 = sext i8 %331 to i32
  %333 = icmp ne i32 %332, 120
  br i1 %333, label %334, label %341

334:                                              ; preds = %327
  %335 = load i32, ptr %3, align 4
  %336 = sext i32 %335 to i64
  %337 = getelementptr inbounds [10 x i8], ptr %2, i64 0, i64 %336
...
345:                                              ; preds = %320, %298, %276, %256
  %346 = call i32 (ptr, ...) @printf(ptr noundef @.str.2)
  ret i32 0
}
