...
504:                                              ; preds = %525, %503
  ...
  %507 = getelementptr inbounds [10 x i8], ptr %2, i64 0, i64 0
  %508 = call i64 @strlen(ptr noundef %507) #5
...
517:                                              ; preds = %510
  ...
  %523 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %522)
  br label %524
...
528:                                              ; preds = %504
  %529 = call i32 (ptr, ...) @printf(ptr noundef @.str.2)
  ret i32 0
}
