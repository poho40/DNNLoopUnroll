; ModuleID = 's942935689.ls.bc'
source_filename = "s942935689.c"
...
203:                                              ; preds = %195
  %204 = call i32 (ptr, ...) @printf(ptr noundef @.str)
  br label %205
...
226:                                              ; preds = %218
  %227 = call i32 (ptr, ...) @printf(ptr noundef @.str)
  br label %228
...
272:                                              ; preds = %264
  %273 = call i32 (ptr, ...) @printf(ptr noundef @.str)
  br label %274
...
314:                                              ; preds = %310
  ...
  %317 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %316)
  br label %320
...
341:                                              ; preds = %333
  %342 = call i32 (ptr, ...) @printf(ptr noundef @.str)
  br label %343
...
373:                                              ; preds = %347, %324, %301, %278, %255, %232, %209, %186, %163, %140, %117, %94, %71, %48, %25, %4
  %374 = call i32 (ptr, ...) @printf(ptr noundef @.str.2)
  ret i32 0
}
