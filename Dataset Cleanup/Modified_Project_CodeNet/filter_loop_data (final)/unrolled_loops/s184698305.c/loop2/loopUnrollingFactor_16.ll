...
647:                                              ; preds = %642
  ...
  %650 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 %649
...
664:                                              ; preds = %658
  ...
  br i1 %668, label %669, label %810

669:                                              ; preds = %664
  %670 = load i32, ptr %3, align 4
  %671 = sext i32 %670 to i64
  %672 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 %671
...
675:                                              ; preds = %669
  ...
  br i1 %679, label %680, label %810

680:                                              ; preds = %675
  %681 = load i32, ptr %3, align 4
  %682 = sext i32 %681 to i64
  %683 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 %682
...
686:                                              ; preds = %680
  ...
  br i1 %690, label %691, label %810

691:                                              ; preds = %686
  %692 = load i32, ptr %3, align 4
  %693 = sext i32 %692 to i64
  %694 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 %693
...
702:                                              ; preds = %697
  ...
  %705 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 %704
...
708:                                              ; preds = %702
  ...
  br i1 %712, label %713, label %810

713:                                              ; preds = %708
  %714 = load i32, ptr %3, align 4
  %715 = sext i32 %714 to i64
  %716 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 %715
...
735:                                              ; preds = %730
  ...
  %738 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 %737
...
746:                                              ; preds = %741
  ...
  %749 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 %748
...
757:                                              ; preds = %752
  ...
  %760 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 %759
...
779:                                              ; preds = %774
  ...
  %782 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 %781
...
790:                                              ; preds = %785
  ...
  %793 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 %792
...
801:                                              ; preds = %796
  ...
  %804 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 %803
...
810:                                              ; preds = %796, %785, %774, %763, %752, %741, %730, %719, %708, %697, %686, %675, %664, %653, %642, %633
  %811 = call i32 (ptr, ...) @printf(ptr noundef @.str.1)
  ret i32 0
}
