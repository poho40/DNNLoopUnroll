...
321:                                              ; preds = %312
  ...
  %324 = getelementptr inbounds [199 x i8], ptr %4, i64 0, i64 %323
...
337:                                              ; preds = %328
  %338 = load i16, ptr %3, align 2
  %339 = zext i16 %338 to i64
  %340 = getelementptr inbounds [199 x i8], ptr %4, i64 0, i64 %339
...
344:                                              ; preds = %337
  %345 = load i16, ptr %3, align 2
  %346 = add i16 %345, 1
  store i16 %346, ptr %3, align 2
  %347 = load i16, ptr %3, align 2
  %348 = zext i16 %347 to i32
  %349 = load i16, ptr %2, align 2
...
353:                                              ; preds = %344
  ...
  %356 = getelementptr inbounds [199 x i8], ptr %4, i64 0, i64 %355
...
360:                                              ; preds = %353
  ...
  %362 = add i16 %361, 1
  store i16 %362, ptr %3, align 2
  %363 = load i16, ptr %3, align 2
...
369:                                              ; preds = %360
  ...
  %372 = getelementptr inbounds [199 x i8], ptr %4, i64 0, i64 %371
...
385:                                              ; preds = %376
  %386 = load i16, ptr %3, align 2
  %387 = zext i16 %386 to i64
  %388 = getelementptr inbounds [199 x i8], ptr %4, i64 0, i64 %387
...
392:                                              ; preds = %385
  ...
  %394 = add i16 %393, 1
  store i16 %394, ptr %3, align 2
  %395 = load i16, ptr %3, align 2
  %396 = zext i16 %395 to i32
  %397 = load i16, ptr %2, align 2
...
401:                                              ; preds = %392
  %402 = load i16, ptr %3, align 2
  %403 = zext i16 %402 to i64
  %404 = getelementptr inbounds [199 x i8], ptr %4, i64 0, i64 %403
...
408:                                              ; preds = %401
  ...
  %410 = add i16 %409, 1
  store i16 %410, ptr %3, align 2
  %411 = load i16, ptr %3, align 2
  %412 = zext i16 %411 to i32
  %413 = load i16, ptr %2, align 2
...
417:                                              ; preds = %408
  ...
  %420 = getelementptr inbounds [199 x i8], ptr %4, i64 0, i64 %419
...
424:                                              ; preds = %417
  %425 = load i16, ptr %3, align 2
  %426 = add i16 %425, 1
  store i16 %426, ptr %3, align 2
  br label %298, !llvm.loop !8

427:                                              ; preds = %408, %392, %376, %360, %344, %328, %312, %298
