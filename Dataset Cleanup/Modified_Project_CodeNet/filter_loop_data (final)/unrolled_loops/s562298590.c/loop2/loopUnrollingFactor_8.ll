...
440:                                              ; preds = %434
  ...
  %443 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %442
  %444 = load i8, ptr %443, align 1
  %445 = sext i8 %444 to i32
  %446 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %445)
  br label %447
...
479:                                              ; preds = %473
  ...
  %482 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %481
...
492:                                              ; preds = %486
  ...
  %498 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %497)
  br label %499
...
518:                                              ; preds = %512
  ...
  %524 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %523)
  br label %525
...
528:                                              ; preds = %512, %499, %486, %473, %460, %447, %434, %423
  ret i32 0
}
