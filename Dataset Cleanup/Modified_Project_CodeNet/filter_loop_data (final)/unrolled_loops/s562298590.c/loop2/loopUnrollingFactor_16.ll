...
831:                                              ; preds = %1037, %830
  ...
  br i1 %834, label %835, label %1040
...
842:                                              ; preds = %835
  ...
  br i1 %847, label %848, label %1040
...
855:                                              ; preds = %848
  ...
  br i1 %860, label %861, label %1040

861:                                              ; preds = %855
  %862 = load i32, ptr %4, align 4
  %863 = sext i32 %862 to i64
  %864 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %863
...
874:                                              ; preds = %868
  ...
  %877 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %876
...
881:                                              ; preds = %874
  ...
  br i1 %886, label %887, label %1040

887:                                              ; preds = %881
  %888 = load i32, ptr %4, align 4
  %889 = sext i32 %888 to i64
  %890 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %889
...
894:                                              ; preds = %887
  ...
  br i1 %899, label %900, label %1040

900:                                              ; preds = %894
  %901 = load i32, ptr %4, align 4
  %902 = sext i32 %901 to i64
  %903 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %902
...
907:                                              ; preds = %900
  ...
  br i1 %912, label %913, label %1040
...
920:                                              ; preds = %913
  ...
  br i1 %925, label %926, label %1040

926:                                              ; preds = %920
  %927 = load i32, ptr %4, align 4
  %928 = sext i32 %927 to i64
  %929 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %928
  %930 = load i8, ptr %929, align 1
  %931 = sext i8 %930 to i32
  %932 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %931)
  br label %933
...
939:                                              ; preds = %933
  ...
  %942 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %941
  %943 = load i8, ptr %942, align 1
  %944 = sext i8 %943 to i32
  %945 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %944)
  br label %946
...
946:                                              ; preds = %939
  ...
  br i1 %951, label %952, label %1040

952:                                              ; preds = %946
  %953 = load i32, ptr %4, align 4
  %954 = sext i32 %953 to i64
  %955 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %954
...
959:                                              ; preds = %952
  ...
  br i1 %964, label %965, label %1040

965:                                              ; preds = %959
  %966 = load i32, ptr %4, align 4
  %967 = sext i32 %966 to i64
  %968 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %967
  %969 = load i8, ptr %968, align 1
  %970 = sext i8 %969 to i32
  %971 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %970)
  br label %972
...
978:                                              ; preds = %972
  ...
  %984 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %983)
  br label %985
...
991:                                              ; preds = %985
  ...
  %994 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %993
  %995 = load i8, ptr %994, align 1
  %996 = sext i8 %995 to i32
  %997 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %996)
  br label %998
...
998:                                              ; preds = %991
  ...
  br i1 %1003, label %1004, label %1040
...
1004:                                             ; preds = %998
  ...
  %1010 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %1009)
  br label %1011
...
1017:                                             ; preds = %1011
  ...
  %1020 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %1019
  %1021 = load i8, ptr %1020, align 1
  %1022 = sext i8 %1021 to i32
  %1023 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %1022)
  br label %1024
...
1030:                                             ; preds = %1024
  ...
  %1036 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %1035)
  br label %1037
...
1040:                                             ; preds = %1024, %1011, %998, %985, %972, %959, %946, %933, %920, %907, %894, %881, %868, %855, %842, %831
  ret i32 0
}
