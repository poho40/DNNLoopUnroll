...
60:                                               ; preds = %56
  ...
  %62 = getelementptr inbounds %struct.stack, ptr %2, i32 0, i32 1
  %63 = load i32, ptr %62, align 4
  %64 = icmp sgt i32 %63, 0
  br i1 %64, label %65, label %67

65:                                               ; preds = %60
  %66 = call signext i8 @pop(ptr noundef %2)
  call void @push(ptr noundef %3, i8 noundef signext %66)
...
68:                                               ; preds = %79, %67
  %69 = getelementptr inbounds %struct.stack, ptr %3, i32 0, i32 1
  %70 = load i32, ptr %69, align 4
  %71 = icmp sgt i32 %70, 0
  br i1 %71, label %72, label %83

72:                                               ; preds = %68
  %73 = call signext i8 @pop(ptr noundef %3)
  %74 = sext i8 %73 to i32
  %75 = call i32 @putchar(i32 noundef %74)
  %76 = getelementptr inbounds %struct.stack, ptr %3, i32 0, i32 1
  %77 = load i32, ptr %76, align 4
  %78 = icmp sgt i32 %77, 0
  br i1 %78, label %79, label %83

79:                                               ; preds = %72
  %80 = call signext i8 @pop(ptr noundef %3)
  %81 = sext i8 %80 to i32
  %82 = call i32 @putchar(i32 noundef %81)
