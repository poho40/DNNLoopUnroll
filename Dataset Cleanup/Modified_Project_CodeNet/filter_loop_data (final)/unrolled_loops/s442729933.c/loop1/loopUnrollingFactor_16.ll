...
231:                                              ; preds = %218, %210, %202, %194, %186, %178, %170, %162, %154, %146, %138, %130, %122, %114, %106, %102
  br label %232
...
345:                                              ; preds = %333, %326, %319, %312, %305, %298, %291, %284, %277, %270, %263, %256, %249, %242, %235, %232
...
349:                                              ; preds = %345
  ...
  %360 = load double, ptr %14, align 8
  %361 = fadd double %360, %359
  store double %361, ptr %14, align 8
...
364:                                              ; preds = %349
  ...
  store double %372, ptr %14, align 8
  br label %373
...
384:                                              ; preds = %374
  ...
  store double %393, ptr %6, align 8
  br label %408
