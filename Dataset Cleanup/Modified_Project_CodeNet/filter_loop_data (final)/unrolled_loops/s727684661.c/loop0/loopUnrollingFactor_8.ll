...
151:                                              ; preds = %147
  ...
  %156 = getelementptr inbounds [20000 x i32], ptr %3, i64 0, i64 0
  %157 = load i32, ptr %156, align 16
  %158 = icmp eq i32 %155, %157
  br i1 %158, label %159, label %163

159:                                              ; preds = %151
  %160 = getelementptr inbounds [20000 x i32], ptr %3, i64 0, i64 1
  %161 = load i32, ptr %160, align 4
  %162 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %161)
  br label %167

163:                                              ; preds = %151
  %164 = getelementptr inbounds [20000 x i32], ptr %3, i64 0, i64 0
