...
206:                                              ; preds = %205
  ...
  %210 = icmp slt i32 %209, 180
  br i1 %210, label %211, label %.loopexit

211:                                              ; preds = %206
  %212 = load i32, ptr %2, align 4
  %213 = sext i32 %212 to i64
  %214 = getelementptr inbounds [180 x double], ptr %11, i64 0, i64 %213
...
220:                                              ; preds = %211
  ...
  %224 = icmp sle i32 2, %223
  br i1 %224, label %203, label %225
...
.loopexit:                                        ; preds = %206, %186
  br label %230

230:                                              ; preds = %.loopexit, %203
