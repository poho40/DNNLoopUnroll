...
656:                                              ; preds = %655
  ...
  %660 = icmp slt i32 %659, 32
  br i1 %660, label %697, label %787
...
677:                                              ; preds = %670
  ...
  %688 = getelementptr inbounds [64 x i32], ptr %685, i64 %687
  %689 = load i32, ptr %13, align 4
  %690 = sext i32 %689 to i64
  %691 = getelementptr inbounds [64 x i32], ptr %688, i64 0, i64 %690
...
702:                                              ; preds = %701
  ...
  %706 = icmp slt i32 %705, 32
  br i1 %706, label %743, label %787
...
723:                                              ; preds = %716
  ...
  %734 = getelementptr inbounds [64 x i32], ptr %731, i64 %733
  %735 = load i32, ptr %13, align 4
  %736 = sext i32 %735 to i64
  %737 = getelementptr inbounds [64 x i32], ptr %734, i64 0, i64 %736
  %738 = load i32, ptr %737, align 4
  %739 = add nsw i32 %738, %730
...
767:                                              ; preds = %760
  ...
  %778 = getelementptr inbounds [64 x i32], ptr %775, i64 %777
  %779 = load i32, ptr %13, align 4
  %780 = sext i32 %779 to i64
  %781 = getelementptr inbounds [64 x i32], ptr %778, i64 0, i64 %780
...
795:                                              ; preds = %792
  ...
  %799 = getelementptr inbounds [64 x i32], ptr %796, i64 %798
  %800 = load i32, ptr %17, align 4
  %801 = sext i32 %800 to i64
  %802 = getelementptr inbounds [64 x i32], ptr %799, i64 0, i64 %801
  %803 = load i32, ptr %802, align 4
  %804 = mul nsw i32 %803, 2
  %805 = load ptr, ptr %4, align 8
  %806 = load i32, ptr %16, align 4
  %807 = sext i32 %806 to i64
  %808 = getelementptr inbounds [64 x i32], ptr %805, i64 %807
  %809 = load i32, ptr %17, align 4
  %810 = sext i32 %809 to i64
  %811 = getelementptr inbounds [64 x i32], ptr %808, i64 0, i64 %810
...
819:                                              ; preds = %815
  ...
  %823 = getelementptr inbounds [64 x i32], ptr %820, i64 %822
  %824 = getelementptr inbounds [64 x i32], ptr %823, i64 0, i64 1
  %825 = load i32, ptr %824, align 4
  %826 = load ptr, ptr %5, align 8
  %827 = load i32, ptr %16, align 4
  %828 = sext i32 %827 to i64
  %829 = getelementptr inbounds [64 x i32], ptr %826, i64 %828
  %830 = getelementptr inbounds [64 x i32], ptr %829, i64 0, i64 0
