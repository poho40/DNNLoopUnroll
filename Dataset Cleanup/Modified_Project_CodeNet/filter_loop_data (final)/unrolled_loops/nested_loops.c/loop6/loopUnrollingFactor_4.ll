...
652:                                              ; preds = %651
  ...
  %656 = icmp slt i32 %655, 32
  br i1 %656, label %685, label %759
...
665:                                              ; preds = %658
  ...
  %676 = getelementptr inbounds [64 x i32], ptr %673, i64 %675
  %677 = load i32, ptr %13, align 4
  %678 = sext i32 %677 to i64
  %679 = getelementptr inbounds [64 x i32], ptr %676, i64 0, i64 %678
...
703:                                              ; preds = %696
  ...
  %714 = getelementptr inbounds [64 x i32], ptr %711, i64 %713
  %715 = load i32, ptr %13, align 4
  %716 = sext i32 %715 to i64
  %717 = getelementptr inbounds [64 x i32], ptr %714, i64 0, i64 %716
...
739:                                              ; preds = %732
  ...
  %750 = getelementptr inbounds [64 x i32], ptr %747, i64 %749
  %751 = load i32, ptr %13, align 4
  %752 = sext i32 %751 to i64
  %753 = getelementptr inbounds [64 x i32], ptr %750, i64 0, i64 %752
  %754 = load i32, ptr %753, align 4
  %755 = add nsw i32 %754, %746
...
760:                                              ; preds = %759
  ...
  %764 = icmp slt i32 %763, 32
  br i1 %764, label %765, label %901
...
770:                                              ; preds = %769
  ...
  %774 = icmp slt i32 %773, 32
  br i1 %774, label %811, label %901
...
791:                                              ; preds = %784
  ...
  %802 = getelementptr inbounds [64 x i32], ptr %799, i64 %801
  %803 = load i32, ptr %13, align 4
  %804 = sext i32 %803 to i64
  %805 = getelementptr inbounds [64 x i32], ptr %802, i64 0, i64 %804
  %806 = load i32, ptr %805, align 4
  %807 = add nsw i32 %806, %798
...
837:                                              ; preds = %830
  ...
  %848 = getelementptr inbounds [64 x i32], ptr %845, i64 %847
  %849 = load i32, ptr %13, align 4
  %850 = sext i32 %849 to i64
  %851 = getelementptr inbounds [64 x i32], ptr %848, i64 0, i64 %850
...
909:                                              ; preds = %906
  ...
  %913 = getelementptr inbounds [64 x i32], ptr %910, i64 %912
  %914 = load i32, ptr %17, align 4
  %915 = sext i32 %914 to i64
  %916 = getelementptr inbounds [64 x i32], ptr %913, i64 0, i64 %915
  %917 = load i32, ptr %916, align 4
  %918 = mul nsw i32 %917, 2
...
933:                                              ; preds = %929
  ...
  %938 = getelementptr inbounds [64 x i32], ptr %937, i64 0, i64 1
  %939 = load i32, ptr %938, align 4
  %940 = load ptr, ptr %5, align 8
  %941 = load i32, ptr %16, align 4
  %942 = sext i32 %941 to i64
  %943 = getelementptr inbounds [64 x i32], ptr %940, i64 %942
  %944 = getelementptr inbounds [64 x i32], ptr %943, i64 0, i64 0
