...
577:                                              ; preds = %572
  ...
  %580 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 %579
...
588:                                              ; preds = %583
  ...
  %591 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 %590
...
594:                                              ; preds = %588
  ...
  br i1 %598, label %599, label %729

599:                                              ; preds = %594
  %600 = load i32, ptr %4, align 4
  %601 = sext i32 %600 to i64
  %602 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 %601
...
610:                                              ; preds = %605
  ...
  %613 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 %612
...
621:                                              ; preds = %616
  ...
  %624 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 %623
...
632:                                              ; preds = %627
  ...
  %635 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 %634
...
643:                                              ; preds = %638
  ...
  %646 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 %645
...
654:                                              ; preds = %649
  ...
  %657 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 %656
...
665:                                              ; preds = %660
  ...
  %668 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 %667
...
676:                                              ; preds = %671
  ...
  %679 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 %678
...
687:                                              ; preds = %682
  ...
  %690 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 %689
...
698:                                              ; preds = %693
  ...
  %701 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 %700
...
709:                                              ; preds = %704
  ...
  %712 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 %711
...
720:                                              ; preds = %715
  ...
  %723 = getelementptr inbounds [3 x i32], ptr %3, i64 0, i64 %722
...
729:                                              ; preds = %715, %704, %693, %682, %671, %660, %649, %638, %627, %616, %605, %594, %583, %572, %561, %552
  ret i32 0
}
