...
1375:                                             ; preds = %1374, %1225
  ...
  br i1 %1377, label %1378, label %1525

1378:                                             ; preds = %1375
  store i32 0, ptr %3, align 4
  br label %1379

1379:                                             ; preds = %1521, %1378
  %1380 = load i32, ptr %3, align 4
  %1381 = load i32, ptr %2, align 4
  %1382 = icmp slt i32 %1380, %1381
  br i1 %1382, label %1383, label %1524
...
1386:                                             ; preds = %1383
  ...
  br i1 %1391, label %1392, label %1524

1392:                                             ; preds = %1386
  %1393 = load i32, ptr %4, align 4
  %1394 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %1393)
  br label %1395
...
1401:                                             ; preds = %1395
  ...
  %1403 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %1402)
  br label %1404
...
1404:                                             ; preds = %1401
  ...
  br i1 %1409, label %1410, label %1524

1410:                                             ; preds = %1404
  %1411 = load i32, ptr %4, align 4
  %1412 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %1411)
  br label %1413
...
1455:                                             ; preds = %1449
  ...
  %1457 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %1456)
  br label %1458
...
1458:                                             ; preds = %1455
  ...
  br i1 %1463, label %1464, label %1524

1464:                                             ; preds = %1458
  %1465 = load i32, ptr %4, align 4
  %1466 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %1465)
  br label %1467
...
1467:                                             ; preds = %1464
  ...
  br i1 %1472, label %1473, label %1524
...
1482:                                             ; preds = %1476
  ...
  %1484 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %1483)
  br label %1485
...
1491:                                             ; preds = %1485
  ...
  %1493 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %1492)
  br label %1494

1494:                                             ; preds = %1491
  %1495 = load i32, ptr %3, align 4
  %1496 = add nsw i32 %1495, 1
  store i32 %1496, ptr %3, align 4
...
1500:                                             ; preds = %1494
  ...
  %1502 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %1501)
  br label %1503

1503:                                             ; preds = %1500
  %1504 = load i32, ptr %3, align 4
  %1505 = add nsw i32 %1504, 1
  store i32 %1505, ptr %3, align 4
...
1509:                                             ; preds = %1503
  ...
  %1511 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %1510)
  br label %1512
...
1518:                                             ; preds = %1512
  ...
  %1520 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %1519)
  br label %1521
...
1524:                                             ; preds = %1512, %1503, %1494, %1485, %1476, %1467, %1458, %1449, %1440, %1431, %1422, %1413, %1404, %1395, %1386, %1379
  br label %1525

1525:                                             ; preds = %1524, %1375
  store i32 0, ptr %1, align 4
  %1526 = load ptr, ptr %8, align 8
  call void @llvm.stackrestore.p0(ptr %1526)
  %1527 = load i32, ptr %1, align 4
  ret i32 %1527
}
