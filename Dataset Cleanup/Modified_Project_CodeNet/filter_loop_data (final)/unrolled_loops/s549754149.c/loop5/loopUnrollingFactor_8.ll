...
651:                                              ; preds = %645
  ...
  %653 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %652)
  br label %654
...
660:                                              ; preds = %654
  ...
  %662 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %661)
  br label %663
...
696:                                              ; preds = %690
  ...
  %698 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %697)
  br label %699
...
702:                                              ; preds = %690, %681, %672, %663, %654, %645, %636, %629
  br label %703
...
707:                                              ; preds = %777, %706
  ...
  br i1 %710, label %711, label %780

711:                                              ; preds = %707
  %712 = load i32, ptr %4, align 4
  %713 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %712)
  br label %714
...
747:                                              ; preds = %741
  ...
  %749 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %748)
  br label %750
...
780:                                              ; preds = %768, %759, %750, %741, %732, %723, %714, %707
  br label %781

781:                                              ; preds = %780, %703
  store i32 0, ptr %1, align 4
  %782 = load ptr, ptr %8, align 8
  call void @llvm.stackrestore.p0(ptr %782)
