...
514:                                              ; preds = %510
  ...
  %516 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %515)
  br label %517
...
529:                                              ; preds = %525
  ...
  %531 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %530)
  br label %532
...
536:                                              ; preds = %535, %521
  ...
  call void @llvm.stackrestore.p0(ptr %537)
