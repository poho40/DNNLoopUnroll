; ModuleID = 's218391809.ls.bc'
source_filename = "s218391809.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [4 x i8] c"F23\00", align 1
...
123:                                              ; preds = %91, %62, %33, %6
  %124 = getelementptr inbounds [4 x i8], ptr %2, i64 0, i64 0
  %125 = load i8, ptr %124, align 1
  %126 = sext i8 %125 to i32
  %127 = getelementptr inbounds [4 x i8], ptr %2, i64 0, i64 1
  %128 = load i8, ptr %127, align 1
  %129 = sext i8 %128 to i32
  %130 = getelementptr inbounds [4 x i8], ptr %2, i64 0, i64 2
  %131 = load i8, ptr %130, align 1
  %132 = sext i8 %131 to i32
  %133 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %126, i32 noundef %129, i32 noundef %132)
  ret i32 0
}
