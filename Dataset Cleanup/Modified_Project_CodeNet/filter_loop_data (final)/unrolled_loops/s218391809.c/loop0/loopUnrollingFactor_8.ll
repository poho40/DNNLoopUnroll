...
239:                                              ; preds = %207, %178, %149, %120, %91, %62, %33, %6
  %240 = getelementptr inbounds [4 x i8], ptr %2, i64 0, i64 0
  %241 = load i8, ptr %240, align 1
  %242 = sext i8 %241 to i32
  %243 = getelementptr inbounds [4 x i8], ptr %2, i64 0, i64 1
  %244 = load i8, ptr %243, align 1
  %245 = sext i8 %244 to i32
  %246 = getelementptr inbounds [4 x i8], ptr %2, i64 0, i64 2
  %247 = load i8, ptr %246, align 1
  %248 = sext i8 %247 to i32
  %249 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %242, i32 noundef %245, i32 noundef %248)
  ret i32 0
}
