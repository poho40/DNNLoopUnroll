...
471:                                              ; preds = %439, %410, %381, %352, %323, %294, %265, %236, %207, %178, %149, %120, %91, %62, %33, %6
  ...
  %475 = getelementptr inbounds [4 x i8], ptr %2, i64 0, i64 1
  %476 = load i8, ptr %475, align 1
  %477 = sext i8 %476 to i32
  %478 = getelementptr inbounds [4 x i8], ptr %2, i64 0, i64 2
  %479 = load i8, ptr %478, align 1
  %480 = sext i8 %479 to i32
  %481 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %474, i32 noundef %477, i32 noundef %480)
  ret i32 0
}
