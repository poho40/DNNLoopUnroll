...
115:                                              ; preds = %110
  ...
  %120 = call double @pow(double noundef 1.000000e+01, double noundef %119) #3
...
132:                                              ; preds = %127
  ...
  %137 = call double @pow(double noundef 1.000000e+01, double noundef %136) #3
  %138 = fdiv double %134, %137
  %139 = fcmp ogt double %138, 1.000000e+00
  br i1 %139, label %140, label %91
...
.loopexit:                                        ; preds = %127, %110, %93, %77
  br label %147

147:                                              ; preds = %.loopexit, %91
