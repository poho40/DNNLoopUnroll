...
2968:                                             ; preds = %2971, %2967
  ...
  br i1 %2970, label %2971, label %2979
...
2980:                                             ; preds = %3011, %2979
  %2981 = load i32, ptr %16, align 4
  %2982 = icmp slt i32 %2981, 100
  br i1 %2982, label %2983, label %3014

2983:                                             ; preds = %2980
  %2984 = load ptr, ptr %5, align 8
  %2985 = load i32, ptr %16, align 4
  %2986 = sext i32 %2985 to i64
  %2987 = getelementptr inbounds i32, ptr %2984, i64 %2986
  %2988 = load i32, ptr %2987, align 4
  %2989 = load ptr, ptr %4, align 8
  %2990 = load i32, ptr %16, align 4
  %2991 = sext i32 %2990 to i64
  %2992 = getelementptr inbounds i32, ptr %2989, i64 %2991
  store i32 %2988, ptr %2992, align 4
  %2993 = load i32, ptr %16, align 4
  %2994 = srem i32 %2993, 5
  %2995 = icmp eq i32 %2994, 0
  br i1 %2995, label %2996, label %3003

2996:                                             ; preds = %2983
  %2997 = load ptr, ptr %5, align 8
  %2998 = load i32, ptr %16, align 4
  %2999 = sext i32 %2998 to i64
  %3000 = getelementptr inbounds i32, ptr %2997, i64 %2999
  %3001 = load i32, ptr %3000, align 4
  %3002 = add nsw i32 %3001, 10
  store i32 %3002, ptr %3000, align 4
  br label %3010

3003:                                             ; preds = %2983
  %3004 = load ptr, ptr %6, align 8
  %3005 = load i32, ptr %16, align 4
  %3006 = sext i32 %3005 to i64
  %3007 = getelementptr inbounds i32, ptr %3004, i64 %3006
  %3008 = load i32, ptr %3007, align 4
  %3009 = sub nsw i32 %3008, 3
  store i32 %3009, ptr %3007, align 4
  br label %3010

3010:                                             ; preds = %3003, %2996
  br label %3011

3011:                                             ; preds = %3010
  %3012 = load i32, ptr %16, align 4
  %3013 = add nsw i32 %3012, 1
  store i32 %3013, ptr %16, align 4
  br label %2980, !llvm.loop !16

3014:                                             ; preds = %2980
  store i32 0, ptr %17, align 4
  br label %3015

3015:                                             ; preds = %3039, %3014
  %3016 = load i32, ptr %17, align 4
  %3017 = icmp slt i32 %3016, 100
...
3019:                                             ; preds = %3035, %3018
  %3020 = load i32, ptr %18, align 4
  %3021 = icmp slt i32 %3020, 100
  br i1 %3021, label %3022, label %3038

3022:                                             ; preds = %3019
  %3023 = load i32, ptr %17, align 4
  %3024 = load i32, ptr %18, align 4
  %3025 = icmp eq i32 %3023, %3024
  br i1 %3025, label %3026, label %3034

3026:                                             ; preds = %3022
  %3027 = load i32, ptr %17, align 4
  %3028 = load i32, ptr %18, align 4
  %3029 = add nsw i32 %3027, %3028
  %3030 = load ptr, ptr %4, align 8
  %3031 = load i32, ptr %17, align 4
  %3032 = sext i32 %3031 to i64
  %3033 = getelementptr inbounds i32, ptr %3030, i64 %3032
  store i32 %3029, ptr %3033, align 4
  br label %3034

3034:                                             ; preds = %3026, %3022
  br label %3035

3035:                                             ; preds = %3034
  %3036 = load i32, ptr %18, align 4
  %3037 = add nsw i32 %3036, 1
  store i32 %3037, ptr %18, align 4
  br label %3019, !llvm.loop !17
