...
376:                                              ; preds = %369
  ...
  %379 = load i16, ptr %3, align 2
  %380 = zext i16 %379 to i32
  %381 = icmp sgt i32 %380, 0
  br i1 %381, label %382, label %574

382:                                              ; preds = %376
  %383 = load i16, ptr %3, align 2
  %384 = zext i16 %383 to i64
  %385 = getelementptr inbounds [100 x i16], ptr %4, i64 0, i64 %384
...
395:                                              ; preds = %389
  %396 = load i16, ptr %3, align 2
  %397 = zext i16 %396 to i64
  %398 = getelementptr inbounds [100 x i16], ptr %4, i64 0, i64 %397
...
408:                                              ; preds = %402
  %409 = load i16, ptr %3, align 2
  %410 = zext i16 %409 to i64
  %411 = getelementptr inbounds [100 x i16], ptr %4, i64 0, i64 %410
...
415:                                              ; preds = %408
  %416 = load i16, ptr %3, align 2
  %417 = add i16 %416, -1
  store i16 %417, ptr %3, align 2
...
421:                                              ; preds = %415
  %422 = load i16, ptr %3, align 2
  %423 = zext i16 %422 to i64
  %424 = getelementptr inbounds [100 x i16], ptr %4, i64 0, i64 %423
...
428:                                              ; preds = %421
  %429 = load i16, ptr %3, align 2
  %430 = add i16 %429, -1
  store i16 %430, ptr %3, align 2
...
434:                                              ; preds = %428
  %435 = load i16, ptr %3, align 2
  %436 = zext i16 %435 to i64
  %437 = getelementptr inbounds [100 x i16], ptr %4, i64 0, i64 %436
...
441:                                              ; preds = %434
  %442 = load i16, ptr %3, align 2
  %443 = add i16 %442, -1
  store i16 %443, ptr %3, align 2
  %444 = load i16, ptr %3, align 2
  %445 = zext i16 %444 to i32
  %446 = icmp sgt i32 %445, 0
  br i1 %446, label %447, label %574

447:                                              ; preds = %441
  %448 = load i16, ptr %3, align 2
  %449 = zext i16 %448 to i64
  %450 = getelementptr inbounds [100 x i16], ptr %4, i64 0, i64 %449
...
460:                                              ; preds = %454
  ...
  %463 = getelementptr inbounds [100 x i16], ptr %4, i64 0, i64 %462
...
467:                                              ; preds = %460
  %468 = load i16, ptr %3, align 2
  %469 = add i16 %468, -1
  store i16 %469, ptr %3, align 2
  %470 = load i16, ptr %3, align 2
  %471 = zext i16 %470 to i32
  %472 = icmp sgt i32 %471, 0
  br i1 %472, label %473, label %574

473:                                              ; preds = %467
  %474 = load i16, ptr %3, align 2
  %475 = zext i16 %474 to i64
  %476 = getelementptr inbounds [100 x i16], ptr %4, i64 0, i64 %475
...
480:                                              ; preds = %473
  %481 = load i16, ptr %3, align 2
  %482 = add i16 %481, -1
  store i16 %482, ptr %3, align 2
...
486:                                              ; preds = %480
  %487 = load i16, ptr %3, align 2
  %488 = zext i16 %487 to i64
  %489 = getelementptr inbounds [100 x i16], ptr %4, i64 0, i64 %488
...
493:                                              ; preds = %486
  %494 = load i16, ptr %3, align 2
  %495 = add i16 %494, -1
  store i16 %495, ptr %3, align 2
...
499:                                              ; preds = %493
  ...
  %502 = getelementptr inbounds [100 x i16], ptr %4, i64 0, i64 %501
...
512:                                              ; preds = %506
  ...
  %515 = getelementptr inbounds [100 x i16], ptr %4, i64 0, i64 %514
...
519:                                              ; preds = %512
  %520 = load i16, ptr %3, align 2
  %521 = add i16 %520, -1
  store i16 %521, ptr %3, align 2
  %522 = load i16, ptr %3, align 2
...
525:                                              ; preds = %519
  ...
  %528 = getelementptr inbounds [100 x i16], ptr %4, i64 0, i64 %527
...
532:                                              ; preds = %525
  %533 = load i16, ptr %3, align 2
  %534 = add i16 %533, -1
  store i16 %534, ptr %3, align 2
  %535 = load i16, ptr %3, align 2
  %536 = zext i16 %535 to i32
  %537 = icmp sgt i32 %536, 0
  br i1 %537, label %538, label %574

538:                                              ; preds = %532
  %539 = load i16, ptr %3, align 2
  %540 = zext i16 %539 to i64
  %541 = getelementptr inbounds [100 x i16], ptr %4, i64 0, i64 %540
  %542 = load i16, ptr %541, align 2
  %543 = zext i16 %542 to i32
  %544 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %543)
  br label %545

545:                                              ; preds = %538
  %546 = load i16, ptr %3, align 2
  %547 = add i16 %546, -1
  store i16 %547, ptr %3, align 2
  %548 = load i16, ptr %3, align 2
  %549 = zext i16 %548 to i32
  %550 = icmp sgt i32 %549, 0
  br i1 %550, label %551, label %574

551:                                              ; preds = %545
  %552 = load i16, ptr %3, align 2
  %553 = zext i16 %552 to i64
  %554 = getelementptr inbounds [100 x i16], ptr %4, i64 0, i64 %553
...
558:                                              ; preds = %551
  %559 = load i16, ptr %3, align 2
  %560 = add i16 %559, -1
  store i16 %560, ptr %3, align 2
  %561 = load i16, ptr %3, align 2
...
564:                                              ; preds = %558
  ...
  %567 = getelementptr inbounds [100 x i16], ptr %4, i64 0, i64 %566
...
571:                                              ; preds = %564
  ...
  %573 = add i16 %572, -1
  store i16 %573, ptr %3, align 2
  br label %365, !llvm.loop !9

574:                                              ; preds = %558, %545, %532, %519, %506, %493, %480, %467, %454, %441, %428, %415, %402, %389, %376, %365
  %575 = getelementptr inbounds [100 x i16], ptr %4, i64 0, i64 0
  %576 = load i16, ptr %575, align 16
