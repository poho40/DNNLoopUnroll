...
659:                                              ; preds = %653
  ...
  br i1 %664, label %665, label %734

665:                                              ; preds = %659
  %666 = load i32, ptr %2, align 4
  %667 = sext i32 %666 to i64
  %668 = getelementptr inbounds [200000 x i32], ptr %6, i64 0, i64 %667
...
677:                                              ; preds = %671
  ...
  %680 = getelementptr inbounds [200000 x i32], ptr %6, i64 0, i64 %679
...
689:                                              ; preds = %683
  ...
  %692 = getelementptr inbounds [200000 x i32], ptr %6, i64 0, i64 %691
...
701:                                              ; preds = %695
  ...
  %704 = getelementptr inbounds [200000 x i32], ptr %6, i64 0, i64 %703
...
734:                                              ; preds = %719, %707, %695, %683, %671, %659, %647, %637
  ret i32 0
}
