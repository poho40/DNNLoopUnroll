...
377:                                              ; preds = %367
  %378 = call i32 (ptr, ...) @printf(ptr noundef @.str.2)
  br label %381

379:                                              ; preds = %367
  %380 = call i32 (ptr, ...) @printf(ptr noundef @.str.1)
  br label %381
...
389:                                              ; preds = %382
  ...
  %392 = getelementptr inbounds [100 x i32], ptr %3, i64 0, i64 %391
...
401:                                              ; preds = %389
  %402 = call i32 (ptr, ...) @printf(ptr noundef @.str.1)
  br label %403
...
489:                                              ; preds = %477
  %490 = call i32 (ptr, ...) @printf(ptr noundef @.str.1)
  br label %491
...
509:                                              ; preds = %499
  %510 = call i32 (ptr, ...) @printf(ptr noundef @.str.2)
  br label %513

511:                                              ; preds = %499
  %512 = call i32 (ptr, ...) @printf(ptr noundef @.str.1)
  br label %513
...
517:                                              ; preds = %492, %470, %448, %426, %404, %382, %360, %340
  ret i32 0
}
