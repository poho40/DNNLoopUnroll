...
681:                                              ; preds = %678
  ...
  br i1 %686, label %687, label %810

687:                                              ; preds = %681
  %688 = load i32, ptr %8, align 4
  %689 = mul nsw i32 %688, 10
...
699:                                              ; preds = %696
  ...
  br i1 %704, label %705, label %810

705:                                              ; preds = %699
  %706 = load i32, ptr %8, align 4
  %707 = mul nsw i32 %706, 10
...
708:                                              ; preds = %705
  ...
  br i1 %713, label %714, label %810

714:                                              ; preds = %708
  %715 = load i32, ptr %8, align 4
  %716 = mul nsw i32 %715, 10
...
810:                                              ; preds = %798, %789, %780, %771, %762, %753, %744, %735, %726, %717, %708, %699, %690, %681, %672, %665
