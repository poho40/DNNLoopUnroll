; ModuleID = 's963221860.ls.bc'
source_filename = "s963221860.c"
...
205:                                              ; preds = %200
  ...
  %208 = getelementptr inbounds [100 x i32], ptr %2, i64 0, i64 %207
...
227:                                              ; preds = %222
  ...
  %230 = getelementptr inbounds [100 x i32], ptr %2, i64 0, i64 %229
...
271:                                              ; preds = %266
  ...
  %274 = getelementptr inbounds [100 x i32], ptr %2, i64 0, i64 %273
...
304:                                              ; preds = %299
  ...
  %307 = getelementptr inbounds [100 x i32], ptr %2, i64 0, i64 %306
...
315:                                              ; preds = %310
  ...
  %318 = getelementptr inbounds [100 x i32], ptr %2, i64 0, i64 %317
...
337:                                              ; preds = %332
  ...
  %340 = getelementptr inbounds [100 x i32], ptr %2, i64 0, i64 %339
...
346:                                              ; preds = %332, %321, %310, %299, %288, %277, %266, %255, %244, %233, %222, %211, %200, %189, %178, %169
  %347 = call i32 @putchar(i32 noundef 10)
  ret i32 0
}
