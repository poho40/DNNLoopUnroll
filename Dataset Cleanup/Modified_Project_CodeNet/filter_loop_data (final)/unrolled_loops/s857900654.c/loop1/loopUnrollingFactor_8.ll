...
97:                                               ; preds = %93
  ...
  %100 = call i32 @max(ptr noundef %10, i32 noundef %98, i32 noundef %99)
...
109:                                              ; preds = %103
  ...
  %112 = call i32 @max(ptr noundef %10, i32 noundef %110, i32 noundef %111)
...
121:                                              ; preds = %115
  ...
  %124 = call i32 @max(ptr noundef %10, i32 noundef %122, i32 noundef %123)
...
133:                                              ; preds = %127
  ...
  %136 = call i32 @max(ptr noundef %10, i32 noundef %134, i32 noundef %135)
...
145:                                              ; preds = %139
  ...
  %148 = call i32 @max(ptr noundef %10, i32 noundef %146, i32 noundef %147)
...
157:                                              ; preds = %151
  ...
  %160 = call i32 @max(ptr noundef %10, i32 noundef %158, i32 noundef %159)
...
169:                                              ; preds = %163
  ...
  %172 = call i32 @max(ptr noundef %10, i32 noundef %170, i32 noundef %171)
...
181:                                              ; preds = %175
  ...
  %184 = call i32 @max(ptr noundef %10, i32 noundef %182, i32 noundef %183)
