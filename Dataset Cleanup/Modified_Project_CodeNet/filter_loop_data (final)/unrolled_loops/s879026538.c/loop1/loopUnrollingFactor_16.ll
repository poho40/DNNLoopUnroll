...
826:                                              ; preds = %1016, %825
  ...
  br i1 %828, label %829, label %1019
...
836:                                              ; preds = %829
  ...
  %840 = icmp sle i32 %839, 9
  br i1 %840, label %841, label %1019

841:                                              ; preds = %836
  %842 = load i32, ptr %3, align 4
  %843 = sext i32 %842 to i64
  %844 = getelementptr inbounds [11 x i8], ptr %5, i64 0, i64 %843
...
848:                                              ; preds = %841
  ...
  %852 = icmp sle i32 %851, 9
  br i1 %852, label %853, label %1019

853:                                              ; preds = %848
  %854 = load i32, ptr %3, align 4
  %855 = sext i32 %854 to i64
  %856 = getelementptr inbounds [11 x i8], ptr %5, i64 0, i64 %855
  %857 = load i8, ptr %856, align 1
  %858 = sext i8 %857 to i32
  %859 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %858)
  br label %860
...
860:                                              ; preds = %853
  ...
  %864 = icmp sle i32 %863, 9
  br i1 %864, label %865, label %1019

865:                                              ; preds = %860
  %866 = load i32, ptr %3, align 4
  %867 = sext i32 %866 to i64
  %868 = getelementptr inbounds [11 x i8], ptr %5, i64 0, i64 %867
...
872:                                              ; preds = %865
  ...
  %876 = icmp sle i32 %875, 9
  br i1 %876, label %877, label %1019

877:                                              ; preds = %872
  %878 = load i32, ptr %3, align 4
  %879 = sext i32 %878 to i64
  %880 = getelementptr inbounds [11 x i8], ptr %5, i64 0, i64 %879
  %881 = load i8, ptr %880, align 1
  %882 = sext i8 %881 to i32
  %883 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %882)
  br label %884
...
884:                                              ; preds = %877
  ...
  %888 = icmp sle i32 %887, 9
  br i1 %888, label %889, label %1019

889:                                              ; preds = %884
  %890 = load i32, ptr %3, align 4
  %891 = sext i32 %890 to i64
  %892 = getelementptr inbounds [11 x i8], ptr %5, i64 0, i64 %891
...
896:                                              ; preds = %889
  ...
  br i1 %900, label %901, label %1019

901:                                              ; preds = %896
  %902 = load i32, ptr %3, align 4
  %903 = sext i32 %902 to i64
  %904 = getelementptr inbounds [11 x i8], ptr %5, i64 0, i64 %903
...
908:                                              ; preds = %901
  ...
  %912 = icmp sle i32 %911, 9
  br i1 %912, label %913, label %1019
...
920:                                              ; preds = %913
  ...
  %924 = icmp sle i32 %923, 9
  br i1 %924, label %925, label %1019

925:                                              ; preds = %920
  %926 = load i32, ptr %3, align 4
  %927 = sext i32 %926 to i64
  %928 = getelementptr inbounds [11 x i8], ptr %5, i64 0, i64 %927
...
932:                                              ; preds = %925
  ...
  %936 = icmp sle i32 %935, 9
  br i1 %936, label %937, label %1019

937:                                              ; preds = %932
  %938 = load i32, ptr %3, align 4
  %939 = sext i32 %938 to i64
  %940 = getelementptr inbounds [11 x i8], ptr %5, i64 0, i64 %939
...
944:                                              ; preds = %937
  ...
  %948 = icmp sle i32 %947, 9
  br i1 %948, label %949, label %1019

949:                                              ; preds = %944
  %950 = load i32, ptr %3, align 4
  %951 = sext i32 %950 to i64
  %952 = getelementptr inbounds [11 x i8], ptr %5, i64 0, i64 %951
  %953 = load i8, ptr %952, align 1
  %954 = sext i8 %953 to i32
  %955 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %954)
  br label %956
...
956:                                              ; preds = %949
  ...
  %960 = icmp sle i32 %959, 9
  br i1 %960, label %961, label %1019

961:                                              ; preds = %956
  %962 = load i32, ptr %3, align 4
  %963 = sext i32 %962 to i64
  %964 = getelementptr inbounds [11 x i8], ptr %5, i64 0, i64 %963
...
973:                                              ; preds = %968
  ...
  %976 = getelementptr inbounds [11 x i8], ptr %5, i64 0, i64 %975
  %977 = load i8, ptr %976, align 1
  %978 = sext i8 %977 to i32
  %979 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %978)
  br label %980
...
980:                                              ; preds = %973
  ...
  %984 = icmp sle i32 %983, 9
  br i1 %984, label %985, label %1019

985:                                              ; preds = %980
  %986 = load i32, ptr %3, align 4
  %987 = sext i32 %986 to i64
  %988 = getelementptr inbounds [11 x i8], ptr %5, i64 0, i64 %987
...
997:                                              ; preds = %992
  ...
  %1000 = getelementptr inbounds [11 x i8], ptr %5, i64 0, i64 %999
...
1009:                                             ; preds = %1004
  ...
  %1012 = getelementptr inbounds [11 x i8], ptr %5, i64 0, i64 %1011
...
1019:                                             ; preds = %1004, %992, %980, %968, %956, %944, %932, %920, %908, %896, %884, %872, %860, %848, %836, %826
