...
253:                                              ; preds = %228
  ...
  %256 = getelementptr inbounds [50 x i8], ptr %8, i64 0, i64 %255
  store i8 0, ptr %256, align 1
  %257 = getelementptr inbounds [50 x i8], ptr %8, i64 0, i64 0
  %258 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, ptr noundef %257)
