...
568:                                              ; preds = %548, %531, %514, %497, %480, %463, %446, %431
  br label %575

569:                                              ; preds = %105
  %570 = getelementptr inbounds [200000 x i32], ptr %3, i64 0, i64 1
  %571 = load i32, ptr %570, align 4
  %572 = getelementptr inbounds [200000 x i32], ptr %3, i64 0, i64 0
  %573 = load i32, ptr %572, align 16
  %574 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %571, i32 noundef %573)
  br label %575
