...
303:                                              ; preds = %299
  ...
  %308 = getelementptr inbounds [2 x i32], ptr %5, i64 0, i64 0
  %309 = load i32, ptr %308, align 4
  %310 = icmp ne i32 %307, %309
  br i1 %310, label %311, label %315

311:                                              ; preds = %303
  %312 = getelementptr inbounds [2 x i32], ptr %5, i64 0, i64 0
  %313 = load i32, ptr %312, align 4
  %314 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %313)
  br label %319

315:                                              ; preds = %303
  %316 = getelementptr inbounds [2 x i32], ptr %5, i64 0, i64 1
