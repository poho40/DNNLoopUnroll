...
648:                                              ; preds = %642
  ...
  %651 = getelementptr inbounds i32, ptr %12, i64 %650
...
658:                                              ; preds = %648
  ...
  %660 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %659)
  br label %661
...
705:                                              ; preds = %682, %662, %642, %622, %602, %582, %562, %544
  br label %781
