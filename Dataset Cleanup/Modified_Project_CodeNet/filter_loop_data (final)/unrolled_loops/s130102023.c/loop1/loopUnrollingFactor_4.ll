...
86:                                               ; preds = %80
  ...
  %89 = getelementptr inbounds [200 x i64], ptr %4, i64 0, i64 %88
  %90 = load i64, ptr %89, align 8
  %91 = trunc i64 %90 to i32
  %92 = call i32 @digit(i32 noundef %91)
...
100:                                              ; preds = %94
  ...
  %103 = getelementptr inbounds [200 x i64], ptr %4, i64 0, i64 %102
  %104 = load i64, ptr %103, align 8
  %105 = trunc i64 %104 to i32
  %106 = call i32 @digit(i32 noundef %105)
...
114:                                              ; preds = %108
  ...
  %117 = getelementptr inbounds [200 x i64], ptr %4, i64 0, i64 %116
  %118 = load i64, ptr %117, align 8
  %119 = trunc i64 %118 to i32
  %120 = call i32 @digit(i32 noundef %119)
