...
795:                                              ; preds = %791
  ...
  %800 = getelementptr inbounds [200000 x i32], ptr %4, i64 0, i64 0
  %801 = load i32, ptr %800, align 16
  %802 = icmp ne i32 %799, %801
  br i1 %802, label %803, label %807

803:                                              ; preds = %795
  %804 = getelementptr inbounds [200000 x i32], ptr %4, i64 0, i64 0
  %805 = load i32, ptr %804, align 16
  %806 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %805)
  br label %811

807:                                              ; preds = %795
  %808 = getelementptr inbounds [200000 x i32], ptr %4, i64 0, i64 1
