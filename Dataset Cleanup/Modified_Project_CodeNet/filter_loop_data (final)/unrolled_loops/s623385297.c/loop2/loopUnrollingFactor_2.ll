...
183:                                              ; preds = %179
  ...
  %188 = getelementptr inbounds [200000 x i32], ptr %4, i64 0, i64 0
  %189 = load i32, ptr %188, align 16
  %190 = icmp ne i32 %187, %189
  br i1 %190, label %191, label %195

191:                                              ; preds = %183
  %192 = getelementptr inbounds [200000 x i32], ptr %4, i64 0, i64 0
  %193 = load i32, ptr %192, align 16
  %194 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %193)
  br label %199

195:                                              ; preds = %183
  %196 = getelementptr inbounds [200000 x i32], ptr %4, i64 0, i64 1
