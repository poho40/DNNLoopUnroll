...
387:                                              ; preds = %383
  ...
  %392 = getelementptr inbounds [200000 x i32], ptr %4, i64 0, i64 0
  %393 = load i32, ptr %392, align 16
  %394 = icmp ne i32 %391, %393
  br i1 %394, label %395, label %399

395:                                              ; preds = %387
  %396 = getelementptr inbounds [200000 x i32], ptr %4, i64 0, i64 0
  %397 = load i32, ptr %396, align 16
  %398 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %397)
  br label %403

399:                                              ; preds = %387
  %400 = getelementptr inbounds [200000 x i32], ptr %4, i64 0, i64 1
