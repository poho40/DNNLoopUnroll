...
336:                                              ; preds = %332
  ...
  %341 = getelementptr inbounds [200000 x i32], ptr %4, i64 0, i64 0
  %342 = load i32, ptr %341, align 16
  %343 = icmp ne i32 %340, %342
  br i1 %343, label %344, label %348

344:                                              ; preds = %336
  %345 = getelementptr inbounds [200000 x i32], ptr %4, i64 0, i64 0
  %346 = load i32, ptr %345, align 16
  %347 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %346)
  br label %352

348:                                              ; preds = %336
  %349 = getelementptr inbounds [200000 x i32], ptr %4, i64 0, i64 1
