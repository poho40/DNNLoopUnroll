...
437:                                              ; preds = %430
  ...
  %441 = getelementptr inbounds i32, ptr %11, i64 %440
...
479:                                              ; preds = %472
  ...
  %483 = getelementptr inbounds i32, ptr %11, i64 %482
...
521:                                              ; preds = %514
  ...
  %525 = getelementptr inbounds i32, ptr %11, i64 %524
...
563:                                              ; preds = %556
  ...
  %567 = getelementptr inbounds i32, ptr %11, i64 %566
...
626:                                              ; preds = %619
  ...
  %630 = getelementptr inbounds i32, ptr %11, i64 %629
...
647:                                              ; preds = %640
  ...
  %651 = getelementptr inbounds i32, ptr %11, i64 %650
...
668:                                              ; preds = %661
  ...
  %672 = getelementptr inbounds i32, ptr %11, i64 %671
...
689:                                              ; preds = %682
  ...
  %693 = getelementptr inbounds i32, ptr %11, i64 %692
...
721:                                              ; preds = %697, %676, %655, %634, %613, %592, %571, %550, %529, %508, %487, %466, %445, %424, %403, %384
  store i32 0, ptr %1, align 4
  %722 = load ptr, ptr %6, align 8
  call void @llvm.stackrestore.p0(ptr %722)
