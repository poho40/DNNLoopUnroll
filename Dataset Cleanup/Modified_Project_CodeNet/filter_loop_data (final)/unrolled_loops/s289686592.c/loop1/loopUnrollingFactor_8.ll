...
154:                                              ; preds = %134, %117, %100, %83, %66, %49, %32, %17
  ...
  call void @qsort(ptr noundef %16, i64 noundef %156, i64 noundef 4, ptr noundef @ord)
  %157 = load i32, ptr %2, align 4
  %158 = sub nsw i32 %157, 1
  %159 = sext i32 %158 to i64
  %160 = getelementptr inbounds i32, ptr %16, i64 %159
...
328:                                              ; preds = %305, %285, %265, %245, %225, %205, %185, %167
  store i32 0, ptr %1, align 4
