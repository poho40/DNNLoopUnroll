...
118:                                              ; preds = %112
  ...
  %123 = getelementptr inbounds %struct.stack, ptr %122, i32 0, i32 1
...
132:                                              ; preds = %126
  ...
  %137 = getelementptr inbounds %struct.stack, ptr %136, i32 0, i32 1
...
140:                                              ; preds = %132
  ...
  %145 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %144)
  br label %146
...
146:                                              ; preds = %140
  ...
  %151 = getelementptr inbounds %struct.stack, ptr %150, i32 0, i32 1
...
160:                                              ; preds = %154
  ...
  %165 = getelementptr inbounds %struct.stack, ptr %164, i32 0, i32 1
...
174:                                              ; preds = %168
  ...
  %179 = getelementptr inbounds %struct.stack, ptr %178, i32 0, i32 1
...
188:                                              ; preds = %182
  ...
  %193 = getelementptr inbounds %struct.stack, ptr %192, i32 0, i32 1
...
196:                                              ; preds = %188
  ...
  %201 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %200)
  br label %202
...
202:                                              ; preds = %196
  ...
  %207 = getelementptr inbounds %struct.stack, ptr %206, i32 0, i32 1
...
210:                                              ; preds = %202
  ...
  %215 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %214)
  br label %216
...
216:                                              ; preds = %210
  ...
  %221 = getelementptr inbounds %struct.stack, ptr %220, i32 0, i32 1
...
224:                                              ; preds = %216
  ...
  %229 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %228)
  br label %230
