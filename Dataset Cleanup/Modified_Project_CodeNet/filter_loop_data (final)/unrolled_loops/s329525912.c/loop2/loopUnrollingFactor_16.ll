...
960:                                              ; preds = %954
  ...
  %966 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %965)
  br label %967
...
967:                                              ; preds = %960
  ...
  br i1 %972, label %973, label %1152

973:                                              ; preds = %967
  %974 = load i32, ptr %4, align 4
  %975 = sext i32 %974 to i64
  %976 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %975
...
980:                                              ; preds = %973
  ...
  br i1 %985, label %986, label %1152

986:                                              ; preds = %980
  %987 = load i32, ptr %4, align 4
  %988 = sext i32 %987 to i64
  %989 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %988
  %990 = load i8, ptr %989, align 1
  %991 = sext i8 %990 to i32
  %992 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %991)
  br label %993
...
993:                                              ; preds = %986
  ...
  br i1 %998, label %999, label %1152

999:                                              ; preds = %993
  %1000 = load i32, ptr %4, align 4
  %1001 = sext i32 %1000 to i64
  %1002 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %1001
  %1003 = load i8, ptr %1002, align 1
  %1004 = sext i8 %1003 to i32
  %1005 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %1004)
  br label %1006
...
1006:                                             ; preds = %999
  ...
  br i1 %1011, label %1012, label %1152
...
1019:                                             ; preds = %1012
  ...
  br i1 %1024, label %1025, label %1152

1025:                                             ; preds = %1019
  %1026 = load i32, ptr %4, align 4
  %1027 = sext i32 %1026 to i64
  %1028 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %1027
...
1038:                                             ; preds = %1032
  ...
  %1041 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %1040
  %1042 = load i8, ptr %1041, align 1
  %1043 = sext i8 %1042 to i32
  %1044 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %1043)
  br label %1045
...
1045:                                             ; preds = %1038
  ...
  br i1 %1050, label %1051, label %1152

1051:                                             ; preds = %1045
  %1052 = load i32, ptr %4, align 4
  %1053 = sext i32 %1052 to i64
  %1054 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %1053
  %1055 = load i8, ptr %1054, align 1
  %1056 = sext i8 %1055 to i32
  %1057 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %1056)
  br label %1058
...
1064:                                             ; preds = %1058
  ...
  %1067 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %1066
...
1071:                                             ; preds = %1064
  ...
  br i1 %1076, label %1077, label %1152

1077:                                             ; preds = %1071
  %1078 = load i32, ptr %4, align 4
  %1079 = sext i32 %1078 to i64
  %1080 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %1079
  %1081 = load i8, ptr %1080, align 1
  %1082 = sext i8 %1081 to i32
  %1083 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %1082)
  br label %1084
...
1090:                                             ; preds = %1084
  ...
  %1093 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %1092
...
1103:                                             ; preds = %1097
  ...
  %1106 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %1105
  %1107 = load i8, ptr %1106, align 1
  %1108 = sext i8 %1107 to i32
  %1109 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %1108)
  br label %1110
...
1116:                                             ; preds = %1110
  ...
  %1119 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %1118
  %1120 = load i8, ptr %1119, align 1
  %1121 = sext i8 %1120 to i32
  %1122 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %1121)
  br label %1123
...
1142:                                             ; preds = %1136
  ...
  %1145 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %1144
  %1146 = load i8, ptr %1145, align 1
  %1147 = sext i8 %1146 to i32
  %1148 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %1147)
  br label %1149

1149:                                             ; preds = %1142
  %1150 = load i32, ptr %4, align 4
  %1151 = add nsw i32 %1150, 1
  store i32 %1151, ptr %4, align 4
  br label %943, !llvm.loop !9

1152:                                             ; preds = %1136, %1123, %1110, %1097, %1084, %1071, %1058, %1045, %1032, %1019, %1006, %993, %980, %967, %954, %943
  ret i32 0
}
