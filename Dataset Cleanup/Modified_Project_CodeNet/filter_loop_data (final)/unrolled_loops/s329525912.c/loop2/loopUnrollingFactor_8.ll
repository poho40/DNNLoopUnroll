...
496:                                              ; preds = %490
  ...
  %502 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %501)
  br label %503
...
522:                                              ; preds = %516
  ...
  %528 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %527)
  br label %529
...
535:                                              ; preds = %529
  ...
  %541 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %540)
  br label %542
...
548:                                              ; preds = %542
  ...
  %551 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %550
  %552 = load i8, ptr %551, align 1
  %553 = sext i8 %552 to i32
  %554 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %553)
  br label %555
...
561:                                              ; preds = %555
  ...
  %567 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %566)
  br label %568
...
574:                                              ; preds = %568
  ...
  %577 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %576
...
584:                                              ; preds = %568, %555, %542, %529, %516, %503, %490, %479
  ret i32 0
}
