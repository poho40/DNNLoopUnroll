...
684:                                              ; preds = %680
  ...
  br i1 %688, label %689, label %813

689:                                              ; preds = %684
  %690 = load i32, ptr %5, align 4
  %691 = sext i32 %690 to i64
  %692 = getelementptr inbounds [10 x i8], ptr %3, i64 0, i64 %691
...
698:                                              ; preds = %693
  ...
  %701 = getelementptr inbounds [10 x i8], ptr %3, i64 0, i64 %700
...
702:                                              ; preds = %698
  ...
  br i1 %706, label %707, label %813

707:                                              ; preds = %702
  %708 = load i32, ptr %5, align 4
  %709 = sext i32 %708 to i64
  %710 = getelementptr inbounds [10 x i8], ptr %3, i64 0, i64 %709
...
716:                                              ; preds = %711
  ...
  %719 = getelementptr inbounds [10 x i8], ptr %3, i64 0, i64 %718
...
725:                                              ; preds = %720
  ...
  %728 = getelementptr inbounds [10 x i8], ptr %3, i64 0, i64 %727
...
743:                                              ; preds = %738
  ...
  %746 = getelementptr inbounds [10 x i8], ptr %3, i64 0, i64 %745
...
747:                                              ; preds = %743
  ...
  br i1 %751, label %752, label %813

752:                                              ; preds = %747
  %753 = load i32, ptr %5, align 4
  %754 = sext i32 %753 to i64
  %755 = getelementptr inbounds [10 x i8], ptr %3, i64 0, i64 %754
...
761:                                              ; preds = %756
  ...
  %764 = getelementptr inbounds [10 x i8], ptr %3, i64 0, i64 %763
...
770:                                              ; preds = %765
  ...
  %773 = getelementptr inbounds [10 x i8], ptr %3, i64 0, i64 %772
...
779:                                              ; preds = %774
  ...
  %782 = getelementptr inbounds [10 x i8], ptr %3, i64 0, i64 %781
...
788:                                              ; preds = %783
  ...
  %791 = getelementptr inbounds [10 x i8], ptr %3, i64 0, i64 %790
...
797:                                              ; preds = %792
  ...
  %800 = getelementptr inbounds [10 x i8], ptr %3, i64 0, i64 %799
...
806:                                              ; preds = %801
  ...
  %809 = getelementptr inbounds [10 x i8], ptr %3, i64 0, i64 %808
...
813:                                              ; preds = %801, %792, %783, %774, %765, %756, %747, %738, %729, %720, %711, %702, %693, %684, %675, %668
  %814 = getelementptr inbounds [10 x i8], ptr %3, i64 0, i64 0
  %815 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, ptr noundef %814)
  ret i32 0
}
