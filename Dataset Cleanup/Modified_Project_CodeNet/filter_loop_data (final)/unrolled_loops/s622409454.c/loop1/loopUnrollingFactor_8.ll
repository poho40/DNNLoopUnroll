...
192:                                              ; preds = %188
  ...
  %196 = getelementptr inbounds %struct.stack, ptr %2, i32 0, i32 1
  %197 = load i32, ptr %196, align 4
  %198 = icmp sgt i32 %197, 0
  br i1 %198, label %199, label %245

199:                                              ; preds = %192
  %200 = call signext i8 @pop(ptr noundef %2)
  %201 = sext i8 %200 to i32
  %202 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %201)
  %203 = getelementptr inbounds %struct.stack, ptr %2, i32 0, i32 1
  %204 = load i32, ptr %203, align 4
  %205 = icmp sgt i32 %204, 0
  br i1 %205, label %206, label %245

206:                                              ; preds = %199
  %207 = call signext i8 @pop(ptr noundef %2)
  %208 = sext i8 %207 to i32
  %209 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %208)
  %210 = getelementptr inbounds %struct.stack, ptr %2, i32 0, i32 1
  %211 = load i32, ptr %210, align 4
  %212 = icmp sgt i32 %211, 0
  br i1 %212, label %213, label %245

213:                                              ; preds = %206
  %214 = call signext i8 @pop(ptr noundef %2)
  %215 = sext i8 %214 to i32
  %216 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %215)
...
220:                                              ; preds = %213
  %221 = call signext i8 @pop(ptr noundef %2)
  %222 = sext i8 %221 to i32
  %223 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %222)
...
227:                                              ; preds = %220
  ...
  %230 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %229)
  %231 = getelementptr inbounds %struct.stack, ptr %2, i32 0, i32 1
  %232 = load i32, ptr %231, align 4
  %233 = icmp sgt i32 %232, 0
  br i1 %233, label %234, label %245

234:                                              ; preds = %227
  %235 = call signext i8 @pop(ptr noundef %2)
  %236 = sext i8 %235 to i32
  %237 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %236)
  %238 = getelementptr inbounds %struct.stack, ptr %2, i32 0, i32 1
  %239 = load i32, ptr %238, align 4
  %240 = icmp sgt i32 %239, 0
  br i1 %240, label %241, label %245

241:                                              ; preds = %234
  %242 = call signext i8 @pop(ptr noundef %2)
  %243 = sext i8 %242 to i32
  %244 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %243)
  br label %188, !llvm.loop !8

245:                                              ; preds = %234, %227, %220, %213, %206, %199, %192, %188
