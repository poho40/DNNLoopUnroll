...
368:                                              ; preds = %364
  ...
  %371 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %370)
  %372 = getelementptr inbounds %struct.stack, ptr %2, i32 0, i32 1
  %373 = load i32, ptr %372, align 4
  %374 = icmp sgt i32 %373, 0
  br i1 %374, label %375, label %477

375:                                              ; preds = %368
  %376 = call signext i8 @pop(ptr noundef %2)
  %377 = sext i8 %376 to i32
  %378 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %377)
...
382:                                              ; preds = %375
  %383 = call signext i8 @pop(ptr noundef %2)
  %384 = sext i8 %383 to i32
  %385 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %384)
  %386 = getelementptr inbounds %struct.stack, ptr %2, i32 0, i32 1
  %387 = load i32, ptr %386, align 4
  %388 = icmp sgt i32 %387, 0
  br i1 %388, label %389, label %477

389:                                              ; preds = %382
  %390 = call signext i8 @pop(ptr noundef %2)
  %391 = sext i8 %390 to i32
  %392 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %391)
...
396:                                              ; preds = %389
  %397 = call signext i8 @pop(ptr noundef %2)
...
403:                                              ; preds = %396
  ...
  %406 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %405)
  %407 = getelementptr inbounds %struct.stack, ptr %2, i32 0, i32 1
  %408 = load i32, ptr %407, align 4
  %409 = icmp sgt i32 %408, 0
  br i1 %409, label %410, label %477

410:                                              ; preds = %403
  %411 = call signext i8 @pop(ptr noundef %2)
  %412 = sext i8 %411 to i32
  %413 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %412)
  %414 = getelementptr inbounds %struct.stack, ptr %2, i32 0, i32 1
  %415 = load i32, ptr %414, align 4
  %416 = icmp sgt i32 %415, 0
  br i1 %416, label %417, label %477

417:                                              ; preds = %410
  %418 = call signext i8 @pop(ptr noundef %2)
  %419 = sext i8 %418 to i32
  %420 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %419)
  %421 = getelementptr inbounds %struct.stack, ptr %2, i32 0, i32 1
  %422 = load i32, ptr %421, align 4
  %423 = icmp sgt i32 %422, 0
  br i1 %423, label %424, label %477

424:                                              ; preds = %417
  %425 = call signext i8 @pop(ptr noundef %2)
  %426 = sext i8 %425 to i32
  %427 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %426)
  %428 = getelementptr inbounds %struct.stack, ptr %2, i32 0, i32 1
  %429 = load i32, ptr %428, align 4
  %430 = icmp sgt i32 %429, 0
  br i1 %430, label %431, label %477

431:                                              ; preds = %424
  %432 = call signext i8 @pop(ptr noundef %2)
...
438:                                              ; preds = %431
  ...
  %442 = getelementptr inbounds %struct.stack, ptr %2, i32 0, i32 1
  %443 = load i32, ptr %442, align 4
  %444 = icmp sgt i32 %443, 0
  br i1 %444, label %445, label %477

445:                                              ; preds = %438
  %446 = call signext i8 @pop(ptr noundef %2)
  %447 = sext i8 %446 to i32
  %448 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %447)
  %449 = getelementptr inbounds %struct.stack, ptr %2, i32 0, i32 1
  %450 = load i32, ptr %449, align 4
  %451 = icmp sgt i32 %450, 0
  br i1 %451, label %452, label %477

452:                                              ; preds = %445
  %453 = call signext i8 @pop(ptr noundef %2)
  %454 = sext i8 %453 to i32
  %455 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %454)
  %456 = getelementptr inbounds %struct.stack, ptr %2, i32 0, i32 1
  %457 = load i32, ptr %456, align 4
  %458 = icmp sgt i32 %457, 0
  br i1 %458, label %459, label %477

459:                                              ; preds = %452
  %460 = call signext i8 @pop(ptr noundef %2)
  %461 = sext i8 %460 to i32
  %462 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %461)
  %463 = getelementptr inbounds %struct.stack, ptr %2, i32 0, i32 1
  %464 = load i32, ptr %463, align 4
  %465 = icmp sgt i32 %464, 0
  br i1 %465, label %466, label %477

466:                                              ; preds = %459
  %467 = call signext i8 @pop(ptr noundef %2)
  %468 = sext i8 %467 to i32
  %469 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %468)
  %470 = getelementptr inbounds %struct.stack, ptr %2, i32 0, i32 1
  %471 = load i32, ptr %470, align 4
  %472 = icmp sgt i32 %471, 0
  br i1 %472, label %473, label %477

473:                                              ; preds = %466
  %474 = call signext i8 @pop(ptr noundef %2)
  %475 = sext i8 %474 to i32
  %476 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %475)
  br label %364, !llvm.loop !8

477:                                              ; preds = %466, %459, %452, %445, %438, %431, %424, %417, %410, %403, %396, %389, %382, %375, %368, %364
  %478 = call i32 (ptr, ...) @printf(ptr noundef @.str.4)
  ret i32 0
}
