...
924:                                              ; preds = %945, %923
  ...
  %927 = getelementptr inbounds [11 x i8], ptr %2, i64 0, i64 0
  %928 = call i64 @strlen(ptr noundef %927) #5
  %929 = icmp ult i64 %926, %928
...
930:                                              ; preds = %924
  ...
  %936 = icmp ne i32 %935, 88
  br i1 %936, label %937, label %944

937:                                              ; preds = %930
  %938 = load i32, ptr %5, align 4
  %939 = sext i32 %938 to i64
  %940 = getelementptr inbounds [11 x i8], ptr %2, i64 0, i64 %939
...
948:                                              ; preds = %924
  %949 = call i32 @puts(ptr noundef @.str.2)
  ret i32 0
}
