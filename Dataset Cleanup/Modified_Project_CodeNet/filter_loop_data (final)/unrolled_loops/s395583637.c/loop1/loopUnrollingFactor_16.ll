...
637:                                              ; preds = %631
  ...
  %640 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %639
  %641 = load i8, ptr %640, align 1
  %642 = sext i8 %641 to i32
  %643 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %642)
  br label %644
...
650:                                              ; preds = %644
  ...
  %653 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %652
...
663:                                              ; preds = %657
  ...
  %669 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %668)
  br label %670
...
676:                                              ; preds = %670
  ...
  %682 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %681)
  br label %683
...
702:                                              ; preds = %696
  ...
  %708 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %707)
  br label %709
...
715:                                              ; preds = %709
  ...
  %721 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %720)
  br label %722
...
741:                                              ; preds = %735
  ...
  %747 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %746)
  br label %748
...
754:                                              ; preds = %748
  ...
  %757 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %756
...
764:                                              ; preds = %748, %735, %722, %709, %696, %683, %670, %657, %644, %631, %618, %605, %592, %579, %566, %555
