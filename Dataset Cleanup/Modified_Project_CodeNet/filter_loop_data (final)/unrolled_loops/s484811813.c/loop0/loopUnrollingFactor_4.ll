...
245:                                              ; preds = %220
  ...
  %248 = getelementptr inbounds [50 x i8], ptr %8, i64 0, i64 %247
  store i8 0, ptr %248, align 1
  %249 = getelementptr inbounds [50 x i8], ptr %8, i64 0, i64 0
  %250 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, ptr noundef %249)
