...
857:                                              ; preds = %832
  ...
  %860 = getelementptr inbounds [50 x i8], ptr %8, i64 0, i64 %859
  store i8 0, ptr %860, align 1
  %861 = getelementptr inbounds [50 x i8], ptr %8, i64 0, i64 0
  %862 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, ptr noundef %861)
  %863 = load i32, ptr %1, align 4
  ret i32 %863
}
