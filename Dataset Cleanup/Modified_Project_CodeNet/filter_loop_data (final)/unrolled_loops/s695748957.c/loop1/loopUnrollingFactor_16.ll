...
610:                                              ; preds = %603
  ...
  br i1 %614, label %615, label %781

615:                                              ; preds = %610
  %616 = load i32, ptr %5, align 4
  %617 = sub nsw i32 2, %616
  %618 = sext i32 %617 to i64
  %619 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 %618
...
622:                                              ; preds = %615
  ...
  br i1 %626, label %627, label %781

627:                                              ; preds = %622
  %628 = load i32, ptr %5, align 4
  %629 = sub nsw i32 2, %628
  %630 = sext i32 %629 to i64
  %631 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 %630
...
634:                                              ; preds = %627
  ...
  br i1 %638, label %639, label %781

639:                                              ; preds = %634
  %640 = load i32, ptr %5, align 4
  %641 = sub nsw i32 2, %640
...
658:                                              ; preds = %651
  ...
  br i1 %662, label %663, label %781

663:                                              ; preds = %658
  %664 = load i32, ptr %5, align 4
  %665 = sub nsw i32 2, %664
  %666 = sext i32 %665 to i64
  %667 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 %666
...
670:                                              ; preds = %663
  ...
  br i1 %674, label %675, label %781

675:                                              ; preds = %670
  %676 = load i32, ptr %5, align 4
  %677 = sub nsw i32 2, %676
  %678 = sext i32 %677 to i64
  %679 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 %678
...
687:                                              ; preds = %682
  ...
  %689 = sub nsw i32 2, %688
  %690 = sext i32 %689 to i64
  %691 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 %690
...
694:                                              ; preds = %687
  ...
  br i1 %698, label %699, label %781

699:                                              ; preds = %694
  %700 = load i32, ptr %5, align 4
  %701 = sub nsw i32 2, %700
  %702 = sext i32 %701 to i64
  %703 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 %702
...
711:                                              ; preds = %706
  ...
  %713 = sub nsw i32 2, %712
  %714 = sext i32 %713 to i64
  %715 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 %714
...
723:                                              ; preds = %718
  ...
  %725 = sub nsw i32 2, %724
  %726 = sext i32 %725 to i64
  %727 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 %726
...
735:                                              ; preds = %730
  ...
  %737 = sub nsw i32 2, %736
  %738 = sext i32 %737 to i64
  %739 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 %738
...
747:                                              ; preds = %742
  ...
  %749 = sub nsw i32 2, %748
  %750 = sext i32 %749 to i64
  %751 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 %750
...
759:                                              ; preds = %754
  ...
  %761 = sub nsw i32 2, %760
  %762 = sext i32 %761 to i64
  %763 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 %762
...
771:                                              ; preds = %766
  ...
  %773 = sub nsw i32 2, %772
  %774 = sext i32 %773 to i64
  %775 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 %774
...
781:                                              ; preds = %766, %754, %742, %730, %718, %706, %694, %682, %670, %658, %646, %634, %622, %610, %598, %588
  %782 = call i32 (ptr, ...) @printf(ptr noundef @.str.1)
  ret i32 0
}
