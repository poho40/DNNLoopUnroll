...
2040:                                             ; preds = %2036
  %2041 = load i32, ptr %6, align 4
  %2042 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %2041)
  br label %2043

2043:                                             ; preds = %2040
  %2044 = load i32, ptr %12, align 4
  %2045 = add nsw i32 %2044, 1
  store i32 %2045, ptr %12, align 4
  br label %2036, !llvm.loop !13

2046:                                             ; preds = %2036
  store i32 0, ptr %1, align 4
  %2047 = load ptr, ptr %3, align 8
  call void @llvm.stackrestore.p0(ptr %2047)
  %2048 = load i32, ptr %1, align 4
  ret i32 %2048
}
