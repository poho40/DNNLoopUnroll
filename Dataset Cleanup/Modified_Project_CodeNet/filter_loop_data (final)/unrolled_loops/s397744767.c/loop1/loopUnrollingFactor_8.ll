...
92:                                               ; preds = %89
  ...
  %96 = call i32 (ptr, ...) @printf(ptr noundef @.str, ptr noundef %95)
  br label %97
...
102:                                              ; preds = %97
  ...
  %106 = call i32 (ptr, ...) @printf(ptr noundef @.str, ptr noundef %105)
  br label %107
...
112:                                              ; preds = %107
  ...
  %116 = call i32 (ptr, ...) @printf(ptr noundef @.str, ptr noundef %115)
  br label %117
...
132:                                              ; preds = %127
  ...
  %136 = call i32 (ptr, ...) @printf(ptr noundef @.str, ptr noundef %135)
  br label %137
...
142:                                              ; preds = %137
  ...
  %146 = call i32 (ptr, ...) @printf(ptr noundef @.str, ptr noundef %145)
  br label %147
...
152:                                              ; preds = %147
  ...
  %156 = call i32 (ptr, ...) @printf(ptr noundef @.str, ptr noundef %155)
  br label %157
...
162:                                              ; preds = %157
  ...
  %166 = call i32 (ptr, ...) @printf(ptr noundef @.str, ptr noundef %165)
  br label %167
...
170:                                              ; preds = %157, %147, %137, %127, %117, %107, %97, %89
  ret i32 0
}
