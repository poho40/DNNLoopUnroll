...
405:                                              ; preds = %402
  %406 = call i32 (ptr, ...) @printf(ptr noundef @.str)
  br label %407

407:                                              ; preds = %405, %402
  %408 = load i32, ptr %3, align 4
  %409 = sext i32 %408 to i64
  %410 = getelementptr inbounds i32, ptr %10, i64 %409
...
423:                                              ; preds = %420
  %424 = call i32 (ptr, ...) @printf(ptr noundef @.str)
  br label %425

425:                                              ; preds = %423, %420
  %426 = load i32, ptr %3, align 4
  %427 = sext i32 %426 to i64
  %428 = getelementptr inbounds i32, ptr %10, i64 %427
...
441:                                              ; preds = %438
  %442 = call i32 (ptr, ...) @printf(ptr noundef @.str)
  br label %443

443:                                              ; preds = %441, %438
  %444 = load i32, ptr %3, align 4
  %445 = sext i32 %444 to i64
  %446 = getelementptr inbounds i32, ptr %10, i64 %445
...
461:                                              ; preds = %459, %456
  ...
  %464 = getelementptr inbounds i32, ptr %10, i64 %463
  %465 = load i32, ptr %464, align 4
  %466 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %465)
  br label %467
...
477:                                              ; preds = %474
  %478 = call i32 (ptr, ...) @printf(ptr noundef @.str)
  br label %479

479:                                              ; preds = %477, %474
  %480 = load i32, ptr %3, align 4
  %481 = sext i32 %480 to i64
  %482 = getelementptr inbounds i32, ptr %10, i64 %481
...
488:                                              ; preds = %467, %449, %431, %413, %395, %377, %359, %343
  %489 = call i32 (ptr, ...) @printf(ptr noundef @.str.2)
  store i32 0, ptr %1, align 4
  %490 = load ptr, ptr %5, align 8
  call void @llvm.stackrestore.p0(ptr %490)
