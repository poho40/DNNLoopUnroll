...
145:                                              ; preds = %140
  ...
  %148 = getelementptr inbounds [4 x i8], ptr %3, i64 0, i64 %147
...
152:                                              ; preds = %145
  %153 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef 1)
  br label %156

154:                                              ; preds = %145
  %155 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef 9)
  br label %156
...
169:                                              ; preds = %162
  %170 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef 1)
  br label %173

171:                                              ; preds = %162
  %172 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef 9)
  br label %173
...
179:                                              ; preds = %174
  ...
  %182 = getelementptr inbounds [4 x i8], ptr %3, i64 0, i64 %181
...
186:                                              ; preds = %179
  %187 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef 1)
  br label %190

188:                                              ; preds = %179
  %189 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef 9)
  br label %190
...
196:                                              ; preds = %191
  ...
  %199 = getelementptr inbounds [4 x i8], ptr %3, i64 0, i64 %198
...
203:                                              ; preds = %196
  %204 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef 1)
  br label %207

205:                                              ; preds = %196
  %206 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef 9)
  br label %207
...
213:                                              ; preds = %208
  ...
  %216 = getelementptr inbounds [4 x i8], ptr %3, i64 0, i64 %215
...
220:                                              ; preds = %213
  %221 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef 1)
  br label %224

222:                                              ; preds = %213
  %223 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef 9)
  br label %224
...
237:                                              ; preds = %230
  %238 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef 1)
  br label %241

239:                                              ; preds = %230
  %240 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef 9)
  br label %241
...
254:                                              ; preds = %247
  %255 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef 1)
  br label %258

256:                                              ; preds = %247
  %257 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef 9)
  br label %258
...
264:                                              ; preds = %259
  ...
  %267 = getelementptr inbounds [4 x i8], ptr %3, i64 0, i64 %266
...
271:                                              ; preds = %264
  %272 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef 1)
  br label %275

273:                                              ; preds = %264
  %274 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef 9)
  br label %275
