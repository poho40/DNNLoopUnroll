...
234:                                              ; preds = %228
  ...
  %236 = sub nsw i32 9999, %235
  %237 = sext i32 %236 to i64
  %238 = getelementptr inbounds [10000 x i8], ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 2), i64 0, i64 %237
...
242:                                              ; preds = %234
  ...
  %246 = load i32, ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 1), align 4
  %247 = icmp slt i32 %245, %246
  br i1 %247, label %248, label %329

248:                                              ; preds = %242
  %249 = load i32, ptr %2, align 4
  %250 = sub nsw i32 9999, %249
  %251 = sext i32 %250 to i64
  %252 = getelementptr inbounds [10000 x i8], ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 2), i64 0, i64 %251
...
256:                                              ; preds = %248
  ...
  %260 = load i32, ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 1), align 4
  %261 = icmp slt i32 %259, %260
  br i1 %261, label %262, label %329

262:                                              ; preds = %256
  %263 = load i32, ptr %2, align 4
  %264 = sub nsw i32 9999, %263
  %265 = sext i32 %264 to i64
  %266 = getelementptr inbounds [10000 x i8], ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 2), i64 0, i64 %265
...
270:                                              ; preds = %262
  ...
  %274 = load i32, ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 1), align 4
  %275 = icmp slt i32 %273, %274
  br i1 %275, label %276, label %329

276:                                              ; preds = %270
  %277 = load i32, ptr %2, align 4
  %278 = sub nsw i32 9999, %277
  %279 = sext i32 %278 to i64
  %280 = getelementptr inbounds [10000 x i8], ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 2), i64 0, i64 %279
...
284:                                              ; preds = %276
  ...
  %288 = load i32, ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 1), align 4
  %289 = icmp slt i32 %287, %288
  br i1 %289, label %290, label %329

290:                                              ; preds = %284
  %291 = load i32, ptr %2, align 4
  %292 = sub nsw i32 9999, %291
  %293 = sext i32 %292 to i64
  %294 = getelementptr inbounds [10000 x i8], ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 2), i64 0, i64 %293
  %295 = load i8, ptr %294, align 1
  %296 = sext i8 %295 to i32
  %297 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %296)
  br label %298
...
298:                                              ; preds = %290
  ...
  %302 = load i32, ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 1), align 4
  %303 = icmp slt i32 %301, %302
  br i1 %303, label %304, label %329

304:                                              ; preds = %298
  %305 = load i32, ptr %2, align 4
  %306 = sub nsw i32 9999, %305
  %307 = sext i32 %306 to i64
  %308 = getelementptr inbounds [10000 x i8], ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 2), i64 0, i64 %307
...
312:                                              ; preds = %304
  ...
  %316 = load i32, ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 1), align 4
  %317 = icmp slt i32 %315, %316
  br i1 %317, label %318, label %329

318:                                              ; preds = %312
  %319 = load i32, ptr %2, align 4
  %320 = sub nsw i32 9999, %319
  %321 = sext i32 %320 to i64
  %322 = getelementptr inbounds [10000 x i8], ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 2), i64 0, i64 %321
...
329:                                              ; preds = %312, %298, %284, %270, %256, %242, %228, %216
