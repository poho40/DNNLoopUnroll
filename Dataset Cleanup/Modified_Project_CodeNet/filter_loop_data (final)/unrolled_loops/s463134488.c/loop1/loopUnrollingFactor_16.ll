...
436:                                              ; preds = %428
  ...
  %440 = load i32, ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 1), align 4
  %441 = icmp slt i32 %439, %440
  br i1 %441, label %442, label %649

442:                                              ; preds = %436
  %443 = load i32, ptr %2, align 4
  %444 = sub nsw i32 9999, %443
  %445 = sext i32 %444 to i64
  %446 = getelementptr inbounds [10000 x i8], ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 2), i64 0, i64 %445
  %447 = load i8, ptr %446, align 1
  %448 = sext i8 %447 to i32
  %449 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %448)
  br label %450
...
450:                                              ; preds = %442
  ...
  %454 = load i32, ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 1), align 4
  %455 = icmp slt i32 %453, %454
  br i1 %455, label %456, label %649

456:                                              ; preds = %450
  %457 = load i32, ptr %2, align 4
  %458 = sub nsw i32 9999, %457
  %459 = sext i32 %458 to i64
  %460 = getelementptr inbounds [10000 x i8], ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 2), i64 0, i64 %459
...
464:                                              ; preds = %456
  ...
  %468 = load i32, ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 1), align 4
  %469 = icmp slt i32 %467, %468
  br i1 %469, label %470, label %649

470:                                              ; preds = %464
  %471 = load i32, ptr %2, align 4
  %472 = sub nsw i32 9999, %471
  %473 = sext i32 %472 to i64
  %474 = getelementptr inbounds [10000 x i8], ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 2), i64 0, i64 %473
...
478:                                              ; preds = %470
  ...
  %482 = load i32, ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 1), align 4
  %483 = icmp slt i32 %481, %482
  br i1 %483, label %484, label %649

484:                                              ; preds = %478
  %485 = load i32, ptr %2, align 4
  %486 = sub nsw i32 9999, %485
  %487 = sext i32 %486 to i64
  %488 = getelementptr inbounds [10000 x i8], ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 2), i64 0, i64 %487
  %489 = load i8, ptr %488, align 1
  %490 = sext i8 %489 to i32
  %491 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %490)
  br label %492
...
492:                                              ; preds = %484
  ...
  %496 = load i32, ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 1), align 4
  %497 = icmp slt i32 %495, %496
  br i1 %497, label %498, label %649

498:                                              ; preds = %492
  %499 = load i32, ptr %2, align 4
  %500 = sub nsw i32 9999, %499
  %501 = sext i32 %500 to i64
  %502 = getelementptr inbounds [10000 x i8], ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 2), i64 0, i64 %501
  %503 = load i8, ptr %502, align 1
  %504 = sext i8 %503 to i32
  %505 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %504)
  br label %506
...
506:                                              ; preds = %498
  ...
  %510 = load i32, ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 1), align 4
  %511 = icmp slt i32 %509, %510
  br i1 %511, label %512, label %649

512:                                              ; preds = %506
  %513 = load i32, ptr %2, align 4
  %514 = sub nsw i32 9999, %513
  %515 = sext i32 %514 to i64
  %516 = getelementptr inbounds [10000 x i8], ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 2), i64 0, i64 %515
...
520:                                              ; preds = %512
  ...
  %524 = load i32, ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 1), align 4
  %525 = icmp slt i32 %523, %524
  br i1 %525, label %526, label %649

526:                                              ; preds = %520
  %527 = load i32, ptr %2, align 4
  %528 = sub nsw i32 9999, %527
  %529 = sext i32 %528 to i64
  %530 = getelementptr inbounds [10000 x i8], ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 2), i64 0, i64 %529
...
534:                                              ; preds = %526
  ...
  %538 = load i32, ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 1), align 4
  %539 = icmp slt i32 %537, %538
  br i1 %539, label %540, label %649

540:                                              ; preds = %534
  %541 = load i32, ptr %2, align 4
  %542 = sub nsw i32 9999, %541
  %543 = sext i32 %542 to i64
  %544 = getelementptr inbounds [10000 x i8], ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 2), i64 0, i64 %543
  %545 = load i8, ptr %544, align 1
  %546 = sext i8 %545 to i32
  %547 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %546)
  br label %548
...
548:                                              ; preds = %540
  ...
  %552 = load i32, ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 1), align 4
  %553 = icmp slt i32 %551, %552
  br i1 %553, label %554, label %649

554:                                              ; preds = %548
  %555 = load i32, ptr %2, align 4
  %556 = sub nsw i32 9999, %555
  %557 = sext i32 %556 to i64
  %558 = getelementptr inbounds [10000 x i8], ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 2), i64 0, i64 %557
...
562:                                              ; preds = %554
  ...
  %566 = load i32, ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 1), align 4
  %567 = icmp slt i32 %565, %566
  br i1 %567, label %568, label %649

568:                                              ; preds = %562
  %569 = load i32, ptr %2, align 4
  %570 = sub nsw i32 9999, %569
  %571 = sext i32 %570 to i64
  %572 = getelementptr inbounds [10000 x i8], ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 2), i64 0, i64 %571
  %573 = load i8, ptr %572, align 1
  %574 = sext i8 %573 to i32
  %575 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %574)
  br label %576
...
576:                                              ; preds = %568
  ...
  %580 = load i32, ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 1), align 4
  %581 = icmp slt i32 %579, %580
  br i1 %581, label %582, label %649

582:                                              ; preds = %576
  %583 = load i32, ptr %2, align 4
  %584 = sub nsw i32 9999, %583
  %585 = sext i32 %584 to i64
  %586 = getelementptr inbounds [10000 x i8], ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 2), i64 0, i64 %585
  %587 = load i8, ptr %586, align 1
  %588 = sext i8 %587 to i32
  %589 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %588)
  br label %590
...
590:                                              ; preds = %582
  ...
  %594 = load i32, ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 1), align 4
  %595 = icmp slt i32 %593, %594
  br i1 %595, label %596, label %649

596:                                              ; preds = %590
  %597 = load i32, ptr %2, align 4
  %598 = sub nsw i32 9999, %597
  %599 = sext i32 %598 to i64
  %600 = getelementptr inbounds [10000 x i8], ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 2), i64 0, i64 %599
...
604:                                              ; preds = %596
  ...
  %608 = load i32, ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 1), align 4
  %609 = icmp slt i32 %607, %608
  br i1 %609, label %610, label %649

610:                                              ; preds = %604
  %611 = load i32, ptr %2, align 4
  %612 = sub nsw i32 9999, %611
  %613 = sext i32 %612 to i64
  %614 = getelementptr inbounds [10000 x i8], ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 2), i64 0, i64 %613
...
618:                                              ; preds = %610
  ...
  %622 = load i32, ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 1), align 4
  %623 = icmp slt i32 %621, %622
  br i1 %623, label %624, label %649

624:                                              ; preds = %618
  %625 = load i32, ptr %2, align 4
  %626 = sub nsw i32 9999, %625
  %627 = sext i32 %626 to i64
  %628 = getelementptr inbounds [10000 x i8], ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 2), i64 0, i64 %627
...
632:                                              ; preds = %624
  ...
  %636 = load i32, ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 1), align 4
  %637 = icmp slt i32 %635, %636
  br i1 %637, label %638, label %649

638:                                              ; preds = %632
  %639 = load i32, ptr %2, align 4
  %640 = sub nsw i32 9999, %639
  %641 = sext i32 %640 to i64
  %642 = getelementptr inbounds [10000 x i8], ptr getelementptr inbounds (%struct.stack, ptr @stk, i32 0, i32 2), i64 0, i64 %641
  %643 = load i8, ptr %642, align 1
  %644 = sext i8 %643 to i32
  %645 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %644)
  br label %646
...
649:                                              ; preds = %632, %618, %604, %590, %576, %562, %548, %534, %520, %506, %492, %478, %464, %450, %436, %424
  %650 = call i32 (ptr, ...) @printf(ptr noundef @.str.2)
  ret i32 0
}
