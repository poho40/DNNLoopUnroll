...
130:                                              ; preds = %124
  ...
  %133 = getelementptr inbounds [10000 x i32], ptr %3, i64 0, i64 %132
...
140:                                              ; preds = %134
  ...
  %143 = getelementptr inbounds [10000 x i32], ptr %3, i64 0, i64 %142
...
160:                                              ; preds = %154
  ...
  %163 = getelementptr inbounds [10000 x i32], ptr %3, i64 0, i64 %162
  store i32 24, ptr %163, align 4
  br label %164
...
172:                                              ; preds = %169
  ...
  %175 = getelementptr inbounds [10000 x i32], ptr %3, i64 0, i64 %174
...
180:                                              ; preds = %398, %383, %368, %353, %338, %323, %308, %293, %278, %263, %248, %233, %218, %203, %188, %172
  br label %411
...
188:                                              ; preds = %183
  ...
  %191 = getelementptr inbounds [10000 x i32], ptr %3, i64 0, i64 %190
...
203:                                              ; preds = %198
  ...
  %206 = getelementptr inbounds [10000 x i32], ptr %3, i64 0, i64 %205
...
233:                                              ; preds = %228
  ...
  %236 = getelementptr inbounds [10000 x i32], ptr %3, i64 0, i64 %235
...
278:                                              ; preds = %273
  ...
  %281 = getelementptr inbounds [10000 x i32], ptr %3, i64 0, i64 %280
  %282 = load i32, ptr %281, align 4
  %283 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %282)
  %284 = load i32, ptr %4, align 4
  %285 = icmp eq i32 %284, 1
  br i1 %285, label %180, label %286
...
308:                                              ; preds = %303
  ...
  %311 = getelementptr inbounds [10000 x i32], ptr %3, i64 0, i64 %310
  %312 = load i32, ptr %311, align 4
  %313 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %312)
  %314 = load i32, ptr %4, align 4
  %315 = icmp eq i32 %314, 1
  br i1 %315, label %180, label %316
...
323:                                              ; preds = %318
  ...
  %326 = getelementptr inbounds [10000 x i32], ptr %3, i64 0, i64 %325
  %327 = load i32, ptr %326, align 4
  %328 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %327)
  %329 = load i32, ptr %4, align 4
  %330 = icmp eq i32 %329, 1
  br i1 %330, label %180, label %331
...
338:                                              ; preds = %333
  ...
  %341 = getelementptr inbounds [10000 x i32], ptr %3, i64 0, i64 %340
  %342 = load i32, ptr %341, align 4
  %343 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %342)
  %344 = load i32, ptr %4, align 4
  %345 = icmp eq i32 %344, 1
  br i1 %345, label %180, label %346
...
.loopexit:                                        ; preds = %393, %378, %363, %348, %333, %318, %303, %288, %273, %258, %243, %228, %213, %198, %183, %169
  br label %411

411:                                              ; preds = %.loopexit, %180
  ret i32 0
}
