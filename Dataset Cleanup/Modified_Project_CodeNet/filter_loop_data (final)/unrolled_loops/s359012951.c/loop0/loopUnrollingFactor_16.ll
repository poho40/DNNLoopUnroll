...
234:                                              ; preds = %220
  %235 = call i64 @strlen(ptr noundef %3) #5
  %236 = sub i64 %235, 1
...
239:                                              ; preds = %238
  ...
  %244 = call i64 @strlen(ptr noundef %2) #5
...
260:                                              ; preds = %246
  %261 = call i64 @strlen(ptr noundef %3) #5
  %262 = sub i64 %261, 1
...
291:                                              ; preds = %290
  ...
  %296 = call i64 @strlen(ptr noundef %2) #5
...
343:                                              ; preds = %342
  ...
  %348 = call i64 @strlen(ptr noundef %2) #5
...
369:                                              ; preds = %368
  ...
  %374 = call i64 @strlen(ptr noundef %2) #5
...
424:                                              ; preds = %395, %369, %343, %317, %291, %265, %239, %213, %187, %161, %135, %109, %83, %57, %31, %7
  ...
  %426 = call i64 @strlen(ptr noundef %425) #5
  %427 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 %426
  store i8 0, ptr %427, align 1
  %428 = getelementptr inbounds [11 x i8], ptr %3, i64 0, i64 0
  %429 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, ptr noundef %428)
  ret i32 0
}
