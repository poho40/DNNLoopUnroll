...
791:                                              ; preds = %785
  ...
  %796 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %795
...
799:                                              ; preds = %791
  ...
  %802 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %801
  %803 = load i32, ptr %802, align 4
  %804 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %803)
  br label %805
...
805:                                              ; preds = %799
  ...
  %810 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %809
  %811 = load i32, ptr %810, align 4
  %812 = icmp ne i32 %811, 3
  br i1 %812, label %813, label %1004

813:                                              ; preds = %805
  %814 = load i32, ptr %6, align 4
  %815 = sext i32 %814 to i64
  %816 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %815
  %817 = load i32, ptr %816, align 4
  %818 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %817)
  br label %819
...
819:                                              ; preds = %813
  ...
  %824 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %823
...
827:                                              ; preds = %819
  ...
  %830 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %829
  %831 = load i32, ptr %830, align 4
  %832 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %831)
  br label %833
...
833:                                              ; preds = %827
  ...
  %838 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %837
  %839 = load i32, ptr %838, align 4
  %840 = icmp ne i32 %839, 3
  br i1 %840, label %841, label %1004

841:                                              ; preds = %833
  %842 = load i32, ptr %6, align 4
  %843 = sext i32 %842 to i64
  %844 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %843
  %845 = load i32, ptr %844, align 4
  %846 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %845)
  br label %847
...
847:                                              ; preds = %841
  ...
  %852 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %851
  %853 = load i32, ptr %852, align 4
  %854 = icmp ne i32 %853, 3
  br i1 %854, label %855, label %1004

855:                                              ; preds = %847
  %856 = load i32, ptr %6, align 4
  %857 = sext i32 %856 to i64
  %858 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %857
...
861:                                              ; preds = %855
  ...
  %866 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %865
  %867 = load i32, ptr %866, align 4
  %868 = icmp ne i32 %867, 3
  br i1 %868, label %869, label %1004

869:                                              ; preds = %861
  %870 = load i32, ptr %6, align 4
  %871 = sext i32 %870 to i64
  %872 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %871
...
875:                                              ; preds = %869
  ...
  %880 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %879
  %881 = load i32, ptr %880, align 4
  %882 = icmp ne i32 %881, 3
  br i1 %882, label %883, label %1004

883:                                              ; preds = %875
  %884 = load i32, ptr %6, align 4
  %885 = sext i32 %884 to i64
  %886 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %885
  %887 = load i32, ptr %886, align 4
  %888 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %887)
  br label %889
...
889:                                              ; preds = %883
  ...
  %894 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %893
  %895 = load i32, ptr %894, align 4
  %896 = icmp ne i32 %895, 3
  br i1 %896, label %897, label %1004

897:                                              ; preds = %889
  %898 = load i32, ptr %6, align 4
  %899 = sext i32 %898 to i64
  %900 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %899
...
903:                                              ; preds = %897
  ...
  %908 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %907
  %909 = load i32, ptr %908, align 4
  %910 = icmp ne i32 %909, 3
  br i1 %910, label %911, label %1004

911:                                              ; preds = %903
  %912 = load i32, ptr %6, align 4
  %913 = sext i32 %912 to i64
  %914 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %913
  %915 = load i32, ptr %914, align 4
  %916 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %915)
  br label %917
...
917:                                              ; preds = %911
  ...
  %922 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %921
  %923 = load i32, ptr %922, align 4
  %924 = icmp ne i32 %923, 3
  br i1 %924, label %925, label %1004

925:                                              ; preds = %917
  %926 = load i32, ptr %6, align 4
  %927 = sext i32 %926 to i64
  %928 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %927
  %929 = load i32, ptr %928, align 4
  %930 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %929)
  br label %931
...
931:                                              ; preds = %925
  ...
  %936 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %935
  %937 = load i32, ptr %936, align 4
  %938 = icmp ne i32 %937, 3
  br i1 %938, label %939, label %1004

939:                                              ; preds = %931
  %940 = load i32, ptr %6, align 4
  %941 = sext i32 %940 to i64
  %942 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %941
...
945:                                              ; preds = %939
  ...
  %950 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %949
...
953:                                              ; preds = %945
  ...
  %956 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %955
  %957 = load i32, ptr %956, align 4
  %958 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %957)
  br label %959
...
959:                                              ; preds = %953
  ...
  %964 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %963
...
967:                                              ; preds = %959
  ...
  %970 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %969
  %971 = load i32, ptr %970, align 4
  %972 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %971)
  br label %973
...
973:                                              ; preds = %967
  ...
  %978 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %977
...
981:                                              ; preds = %973
  ...
  %984 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %983
...
987:                                              ; preds = %981
  ...
  %992 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %991
...
995:                                              ; preds = %987
  ...
  %998 = getelementptr inbounds [20 x i32], ptr %3, i64 0, i64 %997
  %999 = load i32, ptr %998, align 4
  %1000 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %999)
  br label %1001
...
1004:                                             ; preds = %987, %973, %959, %945, %931, %917, %903, %889, %875, %861, %847, %833, %819, %805, %791, %779
  %1005 = load i32, ptr %1, align 4
  ret i32 %1005
}
