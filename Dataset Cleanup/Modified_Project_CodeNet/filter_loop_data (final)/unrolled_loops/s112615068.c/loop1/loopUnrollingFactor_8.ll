...
423:                                              ; preds = %417
  ...
  %426 = getelementptr inbounds [15 x i8], ptr %2, i64 0, i64 %425
...
451:                                              ; preds = %445
  ...
  %454 = getelementptr inbounds [15 x i8], ptr %2, i64 0, i64 %453
...
458:                                              ; preds = %451
  ...
  %461 = getelementptr inbounds [15 x i8], ptr %2, i64 0, i64 %460
...
486:                                              ; preds = %479
  ...
  %489 = getelementptr inbounds [15 x i8], ptr %2, i64 0, i64 %488
...
507:                                              ; preds = %501
  ...
  %510 = getelementptr inbounds [15 x i8], ptr %2, i64 0, i64 %509
...
521:                                              ; preds = %514, %507
  ...
  %524 = getelementptr inbounds [15 x i8], ptr %2, i64 0, i64 %523
  %525 = load i8, ptr %524, align 1
  %526 = sext i8 %525 to i32
  %527 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %526)
  br label %528
...
542:                                              ; preds = %535
  ...
  %545 = getelementptr inbounds [15 x i8], ptr %2, i64 0, i64 %544
...
549:                                              ; preds = %542, %535
  ...
  %555 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %554)
  br label %556
...
563:                                              ; preds = %557
  ...
  %566 = getelementptr inbounds [15 x i8], ptr %2, i64 0, i64 %565
...
570:                                              ; preds = %563
  ...
  %573 = getelementptr inbounds [15 x i8], ptr %2, i64 0, i64 %572
  %574 = load i8, ptr %573, align 1
  %575 = sext i8 %574 to i32
  %576 = icmp eq i32 %575, 48
  br i1 %576, label %577, label %584

577:                                              ; preds = %570, %563
  %578 = load i32, ptr %6, align 4
  %579 = sext i32 %578 to i64
  %580 = getelementptr inbounds [15 x i8], ptr %2, i64 0, i64 %579
...
588:                                              ; preds = %557, %529, %501, %473, %445, %417, %389, %363
  ret i32 0
}
